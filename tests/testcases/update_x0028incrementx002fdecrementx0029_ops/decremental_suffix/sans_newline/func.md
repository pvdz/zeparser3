...
- Path: tests/testcases/update_x0028incrementx002fdecrementx0029_ops/decremental_suffix/sans_newline/func.md
...
tokens (11x):
       ...
       IDENT IDENT PUNC_MIN_MIN PUNC_SEMI PUNC_CURLY_CLOSE
`````
