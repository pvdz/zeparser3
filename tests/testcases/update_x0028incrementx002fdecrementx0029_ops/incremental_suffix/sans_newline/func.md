...
- Path: tests/testcases/update_x0028incrementx002fdecrementx0029_ops/incremental_suffix/sans_newline/func.md
...
tokens (11x):
       ...
       IDENT IDENT PUNC_PLUS_PLUS PUNC_SEMI PUNC_CURLY_CLOSE
`````
