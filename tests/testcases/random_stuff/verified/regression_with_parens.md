...
- Path: tests/testcases/random_stuff/verified/regression_with_parens.md
...
tokens (17x):
       ...
       PUNC_CURLY_CLOSE PUNC_EQ PUNC_PAREN_OPEN IDENT PUNC_PAREN_CLOSE
       PUNC_SEMI PUNC_SEMI PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
       PUNC_CURLY_CLOSE
`````
