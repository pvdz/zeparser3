...
- Path: tests/testcases/for_statement/for-loop/lhs_assign_expr_edge_cases/grouped_arrowx002eprop_lhs.md
...
tokens (17x):
       ...
       PUNC_PAREN_CLOSE PUNC_DOT IDENT PUNC_SEMI PUNC_SEMI
