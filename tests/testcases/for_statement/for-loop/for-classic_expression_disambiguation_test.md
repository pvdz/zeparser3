...
tokens (18x):
       ID_for PUNC_PAREN_OPEN PUNC_PAREN_OPEN IDENT PUNC_STAR IDENT
       PUNC_PLUS IDENT PUNC_PAREN_CLOSE PUNC_STAR IDENT PUNC_SEMI
       IDENT PUNC_SEMI IDENT PUNC_PAREN_CLOSE PUNC_SEMI
`````
