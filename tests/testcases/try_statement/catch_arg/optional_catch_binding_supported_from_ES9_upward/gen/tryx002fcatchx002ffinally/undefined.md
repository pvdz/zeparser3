...
- Path: tests/testcases/try_statement/catch_arg/optional_catch_binding_supported_from_ES9_upward/gen/tryx002fcatchx002ffinally/undefined.md

> :: try statement : catch arg : optional catch binding supported from ES9 upward : gen : tryx002fcatchx002ffinally
>
> ::> undefined
...
tokens (10x):
       ...
       PUNC_CURLY_CLOSE IDENT PUNC_CURLY_OPEN PUNC_CURLY_CLOSE
`````
