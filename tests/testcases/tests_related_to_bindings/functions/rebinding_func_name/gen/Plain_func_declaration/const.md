...
- Path: tests/testcases/tests_related_to_bindings/functions/rebinding_func_name/gen/Plain_func_declaration/const.md
...
tokens (12x):
       ...
       IDENT IDENT PUNC_EQ NUMBER_DEC ASI PUNC_CURLY_CLOSE
`````
