...
- Path: tests/testcases/tests_related_to_bindings/arrow_args/dupe_between_args_and_local_bindings/simple_arg_as_var_name.md
...
tokens (11x):
       ...
       PUNC_CURLY_OPEN ID_var IDENT PUNC_SEMI PUNC_CURLY_CLOSE ASI
`````
