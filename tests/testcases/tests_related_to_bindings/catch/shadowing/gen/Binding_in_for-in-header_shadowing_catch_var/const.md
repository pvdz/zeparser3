...
- Path: tests/testcases/tests_related_to_bindings/catch/shadowing/gen/Binding_in_for-in-header_shadowing_catch_var/const.md

> :: tests related to bindings : catch : shadowing : gen : Binding in for-in-header shadowing catch var
>
> ::> const
