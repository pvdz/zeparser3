...
- Path: tests/testcases/tests_related_to_bindings/catch/shadowing/gen/Binding_in_for-of-header_shadowing_catch_var/let.md

> :: tests related to bindings : catch : shadowing : gen : Binding in for-of-header shadowing catch var
>
> ::> let
...
tokens (19x):
       ...
       PUNC_PAREN_OPEN ID_let IDENT ID_of IDENT PUNC_PAREN_CLOSE
