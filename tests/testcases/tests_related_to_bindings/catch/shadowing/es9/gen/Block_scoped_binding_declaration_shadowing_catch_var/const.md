...
- Path: tests/testcases/tests_related_to_bindings/catch/shadowing/es9/gen/Block_scoped_binding_declaration_shadowing_catch_var/const.md

> :: tests related to bindings : catch : shadowing : es9 : gen : Block scoped binding declaration shadowing catch var
>
> ::> const
...
tokens (17x):
       ...
       IDENT PUNC_PAREN_CLOSE PUNC_CURLY_OPEN PUNC_CURLY_OPEN IDENT
       IDENT PUNC_EQ IDENT PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
