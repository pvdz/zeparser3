...
- Path: tests/testcases/tests_related_to_bindings/methods/classes/dupe_local_vars/funcdecl_and_var.md
...
tokens (21x):
       ...
       PUNC_PAREN_CLOSE PUNC_CURLY_OPEN IDENT IDENT PUNC_PAREN_OPEN
       PUNC_PAREN_CLOSE PUNC_CURLY_OPEN PUNC_CURLY_CLOSE IDENT IDENT
       PUNC_EQ IDENT PUNC_SEMI PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
`````
