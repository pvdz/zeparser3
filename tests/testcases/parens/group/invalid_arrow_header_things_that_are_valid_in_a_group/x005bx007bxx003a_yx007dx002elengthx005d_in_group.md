...
- Path: tests/testcases/parens/group/invalid_arrow_header_things_that_are_valid_in_a_group/x005bx007bxx003a_yx007dx002elengthx005d_in_group.md

> :: parens : group : invalid arrow header things that are valid in a group
>
> ::> x005bx007bxx003a yx007dx002elengthx005d in group
...
tokens (11x):
       ...
       PUNC_CURLY_CLOSE PUNC_DOT IDENT PUNC_PAREN_CLOSE PUNC_SEMI
`````
