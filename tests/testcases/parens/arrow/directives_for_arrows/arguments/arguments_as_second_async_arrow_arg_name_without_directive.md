...
- Path: tests/testcases/parens/arrow/directives_for_arrows/arguments/arguments_as_second_async_arrow_arg_name_without_directive.md
...
tokens (11x):
       ID_async PUNC_PAREN_OPEN IDENT PUNC_COMMA ID_arguments
