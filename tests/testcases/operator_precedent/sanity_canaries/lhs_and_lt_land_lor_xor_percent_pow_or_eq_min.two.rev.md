...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_lt_land_lor_xor_percent_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and lt land lor xor percent pow or eq min.two.rev
>
