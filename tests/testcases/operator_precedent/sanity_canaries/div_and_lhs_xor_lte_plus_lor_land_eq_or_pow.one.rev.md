...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_lte_plus_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor lte plus lor land eq or pow.one.rev
>
