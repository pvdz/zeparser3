...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_lhs_xor_instanceof_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and lhs xor instanceof min lor land eq or pow.one.rev
>
