...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_lhs_xor_gte_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and lhs xor gte plus lor land sneq or pow.one.rev
>
