...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_gte_land_lor_xor_div_pow_or_neq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and gte land lor xor div pow or neq min.two.rev
>
