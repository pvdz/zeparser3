...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_seq_land_lor_min_instanceof_xor_rhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or seq land lor min instanceof xor rhs and percent.one
>
