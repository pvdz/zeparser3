...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_seq_land_lor_min_lt_xor_urhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or seq land lor min lt xor urhs and mul.one
>
