...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_neq_land_lor_min_lte_xor_rhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or neq land lor min lte xor rhs and percent.one
>
