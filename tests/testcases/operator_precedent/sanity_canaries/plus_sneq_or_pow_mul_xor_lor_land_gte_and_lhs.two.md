...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_sneq_or_pow_mul_xor_lor_land_gte_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus sneq or pow mul xor lor land gte and lhs.two
>
