...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_instanceof_land_lor_xor_div_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and instanceof land lor xor div pow or eq min.two.rev
>
