...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_seq_land_lor_plus_gte_xor_lhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or seq land lor plus gte xor lhs and mul.one
>
