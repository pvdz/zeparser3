...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_lte_land_lor_xor_mul_pow_or_seq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and lte land lor xor mul pow or seq min.two.rev
>
