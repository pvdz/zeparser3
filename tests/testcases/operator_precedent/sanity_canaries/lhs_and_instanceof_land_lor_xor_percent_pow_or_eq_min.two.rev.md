...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_instanceof_land_lor_xor_percent_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and instanceof land lor xor percent pow or eq min.two.rev
>
...
tokens (25x):
       ...
       PUNC_STAR_STAR IDENT PUNC_OR IDENT PUNC_EQ_EQ IDENT PUNC_MIN
       IDENT ASI
`````
