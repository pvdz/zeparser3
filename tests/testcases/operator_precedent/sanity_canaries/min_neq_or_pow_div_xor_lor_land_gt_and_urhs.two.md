...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_neq_or_pow_div_xor_lor_land_gt_and_urhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min neq or pow div xor lor land gt and urhs.two
>
