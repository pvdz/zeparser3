...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_rhs_xor_instanceof_plus_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and rhs xor instanceof plus lor land seq or pow.one.rev
>
