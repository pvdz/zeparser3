...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_min_in_xor_lhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor min in xor lhs and percent.one
>
