...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_lt_min_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor lt min lor land neq or pow.one.rev
>
