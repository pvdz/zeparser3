...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_in_plus_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor in plus lor land eq or pow.one.rev
>
