...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_rhs_xor_in_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and rhs xor in plus lor land sneq or pow.one.rev
>
