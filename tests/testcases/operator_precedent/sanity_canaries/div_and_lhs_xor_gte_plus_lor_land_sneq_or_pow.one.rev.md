...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_gte_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor gte plus lor land sneq or pow.one.rev
>
...
tokens (25x):
       ...
       IDENT PUNC_GT_EQ IDENT PUNC_PLUS IDENT PUNC_OR_OR IDENT
