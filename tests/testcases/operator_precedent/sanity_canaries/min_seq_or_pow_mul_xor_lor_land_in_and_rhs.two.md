...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_seq_or_pow_mul_xor_lor_land_in_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min seq or pow mul xor lor land in and rhs.two
>
