...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_rhs_xor_gt_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and rhs xor gt min lor land eq or pow.one.rev
>
