...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_gt_land_lor_xor_percent_pow_or_neq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and gt land lor xor percent pow or neq min.two.rev
>
