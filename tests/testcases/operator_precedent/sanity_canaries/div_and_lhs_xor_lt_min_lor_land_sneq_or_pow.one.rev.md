...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_lt_min_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor lt min lor land sneq or pow.one.rev
>
...
tokens (25x):
       ...
       IDENT PUNC_LT IDENT PUNC_MIN IDENT PUNC_OR_OR IDENT
