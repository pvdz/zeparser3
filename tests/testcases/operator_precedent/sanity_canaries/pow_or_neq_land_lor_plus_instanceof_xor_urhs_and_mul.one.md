...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_neq_land_lor_plus_instanceof_xor_urhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or neq land lor plus instanceof xor urhs and mul.one
>
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          type: 'BinaryExpression',
          loc:{start:{line:1,column:29},end:{line:1,column:72},source:''},
          left: {
            type: 'BinaryExpression',
