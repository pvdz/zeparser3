...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_rhs_xor_gt_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and rhs xor gt plus lor land sneq or pow.one.rev
>
