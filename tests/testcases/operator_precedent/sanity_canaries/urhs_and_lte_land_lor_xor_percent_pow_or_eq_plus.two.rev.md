...
- Path: tests/testcases/operator_precedent/sanity_canaries/urhs_and_lte_land_lor_xor_percent_pow_or_eq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> urhs and lte land lor xor percent pow or eq plus.two.rev
>
...
tokens (25x):
       ...
       PUNC_EQ_EQ IDENT PUNC_PLUS IDENT ASI
`````
