...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_lte_min_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor lte min lor land sneq or pow.one.rev
>
