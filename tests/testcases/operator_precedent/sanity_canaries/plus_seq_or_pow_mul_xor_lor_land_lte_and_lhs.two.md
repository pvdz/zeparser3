...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_seq_or_pow_mul_xor_lor_land_lte_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus seq or pow mul xor lor land lte and lhs.two
>
