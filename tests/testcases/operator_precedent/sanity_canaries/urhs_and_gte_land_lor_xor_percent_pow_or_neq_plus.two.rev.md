...
- Path: tests/testcases/operator_precedent/sanity_canaries/urhs_and_gte_land_lor_xor_percent_pow_or_neq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> urhs and gte land lor xor percent pow or neq plus.two.rev
>
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          right: {
            type: 'BinaryExpression',
            loc:{start:{line:1,column:51},end:{line:1,column:64},source:''},
            left: {
              type: 'Identifier',
...
tokens (25x):
       ...
       PUNC_EXCL_EQ IDENT PUNC_PLUS IDENT ASI
`````
