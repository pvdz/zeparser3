...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_lhs_xor_in_plus_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and lhs xor in plus lor land seq or pow.one.rev
>
