...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_eq_or_pow_div_xor_lor_land_gte_and_urhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min eq or pow div xor lor land gte and urhs.two
>
