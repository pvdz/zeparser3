...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_seq_land_lor_min_lt_xor_lhs_and_div.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or seq land lor min lt xor lhs and div.one
>
