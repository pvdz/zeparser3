...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_seq_land_lor_min_lte_xor_lhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or seq land lor min lte xor lhs and mul.one
>
