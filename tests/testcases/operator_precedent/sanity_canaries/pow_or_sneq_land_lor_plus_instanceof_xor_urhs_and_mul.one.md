...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_plus_instanceof_xor_urhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor plus instanceof xor urhs and mul.one
>
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          type: 'BinaryExpression',
          loc:{start:{line:1,column:30},end:{line:1,column:73},source:''},
          left: {
            type: 'BinaryExpression',
...
tokens (25x):
       ...
       PUNC_AND_AND IDENT PUNC_OR_OR IDENT PUNC_PLUS IDENT IDENT IDENT
       PUNC_CARET IDENT PUNC_GT_GT_GT IDENT PUNC_AND IDENT PUNC_STAR
       IDENT ASI
`````
