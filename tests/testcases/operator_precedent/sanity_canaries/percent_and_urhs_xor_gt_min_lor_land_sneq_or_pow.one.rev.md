...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_gt_min_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor gt min lor land sneq or pow.one.rev
>
...
tokens (25x):
       ...
       PUNC_CARET IDENT PUNC_GT IDENT PUNC_MIN IDENT PUNC_OR_OR IDENT
