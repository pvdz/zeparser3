...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_gt_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor gt min lor land eq or pow.one.rev
>
