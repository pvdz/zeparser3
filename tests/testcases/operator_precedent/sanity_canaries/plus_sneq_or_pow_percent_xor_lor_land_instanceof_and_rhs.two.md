...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_sneq_or_pow_percent_xor_lor_land_instanceof_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus sneq or pow percent xor lor land instanceof and rhs.two
>
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          type: 'LogicalExpression',
          loc:{start:{line:1,column:39},end:{line:1,column:72},source:''},
          left: {
            type: 'Identifier',
          ...
          right: {
            type: 'BinaryExpression',
            loc:{start:{line:1,column:45},end:{line:1,column:72},source:''},
            left: {
              type: 'BinaryExpression',
...
tokens (25x):
       ...
       PUNC_OR_OR IDENT PUNC_AND_AND IDENT IDENT IDENT PUNC_AND IDENT
