...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_gte_plus_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor gte plus lor land eq or pow.one.rev
>
