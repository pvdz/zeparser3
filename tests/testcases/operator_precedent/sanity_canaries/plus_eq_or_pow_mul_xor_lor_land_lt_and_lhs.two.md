...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_eq_or_pow_mul_xor_lor_land_lt_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus eq or pow mul xor lor land lt and lhs.two
>
