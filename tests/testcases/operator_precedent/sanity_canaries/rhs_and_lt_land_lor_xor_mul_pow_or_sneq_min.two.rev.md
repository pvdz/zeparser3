...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_lt_land_lor_xor_mul_pow_or_sneq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and lt land lor xor mul pow or sneq min.two.rev
>
