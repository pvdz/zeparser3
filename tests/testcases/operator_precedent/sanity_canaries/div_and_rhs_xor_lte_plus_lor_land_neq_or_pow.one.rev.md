...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_lte_plus_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor lte plus lor land neq or pow.one.rev
>
