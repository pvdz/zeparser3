...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_lte_land_lor_xor_mul_pow_or_seq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and lte land lor xor mul pow or seq plus.two.rev
>
