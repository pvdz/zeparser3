...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_lhs_xor_in_plus_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and lhs xor in plus lor land neq or pow.one.rev
>
