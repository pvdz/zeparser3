...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_gte_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor gte min lor land eq or pow.one.rev
>
