...
- Path: tests/testcases/operator_precedent/sanity_canaries/urhs_and_gte_land_lor_xor_percent_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> urhs and gte land lor xor percent pow or eq min.two.rev
>
