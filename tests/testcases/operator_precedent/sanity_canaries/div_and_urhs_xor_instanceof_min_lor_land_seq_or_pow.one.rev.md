...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_urhs_xor_instanceof_min_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and urhs xor instanceof min lor land seq or pow.one.rev
>
