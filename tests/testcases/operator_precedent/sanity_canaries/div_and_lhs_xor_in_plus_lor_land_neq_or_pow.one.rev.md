...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_in_plus_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor in plus lor land neq or pow.one.rev
>
...
tokens (25x):
       ...
       IDENT PUNC_EXCL_EQ IDENT PUNC_OR IDENT PUNC_STAR_STAR IDENT ASI
`````
