...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_lte_land_lor_xor_mul_pow_or_neq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and lte land lor xor mul pow or neq plus.two.rev
>
