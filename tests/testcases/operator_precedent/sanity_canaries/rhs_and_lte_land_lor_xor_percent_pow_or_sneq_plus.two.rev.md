...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_lte_land_lor_xor_percent_pow_or_sneq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and lte land lor xor percent pow or sneq plus.two.rev
>
...
tokens (25x):
       IDENT PUNC_GT_GT IDENT PUNC_AND IDENT PUNC_LT_EQ IDENT
