...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_neq_land_lor_min_lt_xor_lhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or neq land lor min lt xor lhs and mul.one
>
