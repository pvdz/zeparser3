...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_eq_or_pow_percent_xor_lor_land_gte_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min eq or pow percent xor lor land gte and rhs.two
>
