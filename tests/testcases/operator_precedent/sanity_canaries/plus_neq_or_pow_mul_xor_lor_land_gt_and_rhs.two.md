...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_neq_or_pow_mul_xor_lor_land_gt_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus neq or pow mul xor lor land gt and rhs.two
>
