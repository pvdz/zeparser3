...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_eq_or_pow_div_xor_lor_land_instanceof_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus eq or pow div xor lor land instanceof and lhs.two
>
