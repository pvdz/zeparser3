...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_instanceof_land_lor_xor_mul_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and instanceof land lor xor mul pow or eq min.two.rev
>
