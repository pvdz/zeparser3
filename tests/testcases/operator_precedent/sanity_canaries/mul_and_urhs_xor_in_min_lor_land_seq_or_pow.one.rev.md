...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_urhs_xor_in_min_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and urhs xor in min lor land seq or pow.one.rev
>
