...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_urhs_xor_lt_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and urhs xor lt min lor land eq or pow.one.rev
>
