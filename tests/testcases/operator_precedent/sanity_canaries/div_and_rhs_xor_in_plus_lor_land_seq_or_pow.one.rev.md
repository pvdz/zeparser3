...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_in_plus_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor in plus lor land seq or pow.one.rev
>
...
tokens (25x):
       ...
       IDENT PUNC_EQ_EQ_EQ IDENT PUNC_OR IDENT PUNC_STAR_STAR IDENT
       ASI
`````
