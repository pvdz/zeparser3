...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_instanceof_land_lor_xor_percent_pow_or_neq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and instanceof land lor xor percent pow or neq plus.two.rev
>
...
tokens (25x):
       IDENT PUNC_LT_LT IDENT PUNC_AND IDENT IDENT IDENT PUNC_AND_AND
       IDENT PUNC_OR_OR IDENT PUNC_CARET IDENT PUNC_PERCENT IDENT
       PUNC_STAR_STAR IDENT PUNC_OR IDENT PUNC_EXCL_EQ IDENT PUNC_PLUS
       IDENT ASI
`````
