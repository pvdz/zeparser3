...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_sneq_or_pow_div_xor_lor_land_lt_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min sneq or pow div xor lor land lt and lhs.two
>
