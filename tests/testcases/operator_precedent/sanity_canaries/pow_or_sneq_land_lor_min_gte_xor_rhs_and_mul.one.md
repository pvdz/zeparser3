...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_min_gte_xor_rhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor min gte xor rhs and mul.one
>
