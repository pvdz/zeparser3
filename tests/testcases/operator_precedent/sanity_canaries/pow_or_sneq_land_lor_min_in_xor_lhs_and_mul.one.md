...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_min_in_xor_lhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor min in xor lhs and mul.one
>
