...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_plus_gte_xor_lhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor plus gte xor lhs and percent.one
>
