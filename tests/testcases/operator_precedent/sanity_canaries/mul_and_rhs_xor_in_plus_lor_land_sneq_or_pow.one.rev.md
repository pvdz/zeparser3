...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_rhs_xor_in_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and rhs xor in plus lor land sneq or pow.one.rev
>
