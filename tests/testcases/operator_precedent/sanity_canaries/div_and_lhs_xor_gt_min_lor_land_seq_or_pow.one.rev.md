...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_gt_min_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor gt min lor land seq or pow.one.rev
>
