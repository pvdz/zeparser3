...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_plus_instanceof_xor_lhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor plus instanceof xor lhs and mul.one
>
...
tokens (25x):
       ...
       PUNC_CARET IDENT PUNC_LT_LT IDENT PUNC_AND IDENT PUNC_STAR
       IDENT ASI
`````
