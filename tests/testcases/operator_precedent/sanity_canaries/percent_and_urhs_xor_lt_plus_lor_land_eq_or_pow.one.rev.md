...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_lt_plus_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor lt plus lor land eq or pow.one.rev
>
