...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_urhs_xor_in_plus_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and urhs xor in plus lor land eq or pow.one.rev
>
