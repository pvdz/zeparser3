...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_plus_gt_xor_lhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor plus gt xor lhs and mul.one
>
