...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_gt_plus_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor gt plus lor land neq or pow.one.rev
>
