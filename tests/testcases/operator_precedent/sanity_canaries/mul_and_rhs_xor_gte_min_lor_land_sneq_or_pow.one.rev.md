...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_rhs_xor_gte_min_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and rhs xor gte min lor land sneq or pow.one.rev
>
