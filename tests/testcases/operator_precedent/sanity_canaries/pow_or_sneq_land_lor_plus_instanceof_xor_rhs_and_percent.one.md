...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_plus_instanceof_xor_rhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor plus instanceof xor rhs and percent.one
>
...
tokens (25x):
       ...
       PUNC_CARET IDENT PUNC_GT_GT IDENT PUNC_AND IDENT PUNC_PERCENT
       IDENT ASI
`````
