...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_lte_land_lor_xor_percent_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and lte land lor xor percent pow or eq min.two.rev
>
