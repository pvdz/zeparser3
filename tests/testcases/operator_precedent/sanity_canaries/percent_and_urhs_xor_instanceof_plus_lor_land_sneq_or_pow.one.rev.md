...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_instanceof_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor instanceof plus lor land sneq or pow.one.rev
>
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          type: 'LogicalExpression',
          loc:{start:{line:1,column:47},end:{line:1,column:73},source:''},
          left: {
            type: 'Identifier',
          ...
          right: {
            type: 'BinaryExpression',
            loc:{start:{line:1,column:53},end:{line:1,column:73},source:''},
            left: {
              type: 'BinaryExpression',
            ...
            right: {
              type: 'BinaryExpression',
              loc:{start:{line:1,column:65},end:{line:1,column:73},source:''},
              left: {
                type: 'Identifier',
