...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_gt_land_lor_xor_mul_pow_or_sneq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and gt land lor xor mul pow or sneq plus.two.rev
>
