...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_seq_or_pow_mul_xor_lor_land_lte_and_urhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min seq or pow mul xor lor land lte and urhs.two
>
