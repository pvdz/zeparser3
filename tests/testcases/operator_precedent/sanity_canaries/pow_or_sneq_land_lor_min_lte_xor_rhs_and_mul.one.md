...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_min_lte_xor_rhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor min lte xor rhs and mul.one
>
