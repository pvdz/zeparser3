...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_neq_or_pow_percent_xor_lor_land_in_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min neq or pow percent xor lor land in and lhs.two
>
