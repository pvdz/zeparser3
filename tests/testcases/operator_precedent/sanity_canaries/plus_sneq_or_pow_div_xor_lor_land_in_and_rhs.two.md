...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_sneq_or_pow_div_xor_lor_land_in_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus sneq or pow div xor lor land in and rhs.two
>
...
tokens (25x):
       ...
       IDENT PUNC_AND_AND IDENT ID_in IDENT PUNC_AND IDENT PUNC_GT_GT
       IDENT ASI
`````
