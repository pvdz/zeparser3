...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_seq_land_lor_plus_instanceof_xor_rhs_and_div.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or seq land lor plus instanceof xor rhs and div.one
>
...
tokens (25x):
       ...
       PUNC_CARET IDENT PUNC_GT_GT IDENT PUNC_AND IDENT PUNC_DIV IDENT
       ASI
`````
