...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_lt_land_lor_xor_mul_pow_or_neq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and lt land lor xor mul pow or neq min.two.rev
>
