...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_gt_plus_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor gt plus lor land neq or pow.one.rev
>
