...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_sneq_or_pow_mul_xor_lor_land_lte_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min sneq or pow mul xor lor land lte and rhs.two
>
