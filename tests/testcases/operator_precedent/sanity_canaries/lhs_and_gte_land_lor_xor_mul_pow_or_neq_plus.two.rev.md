...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_gte_land_lor_xor_mul_pow_or_neq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and gte land lor xor mul pow or neq plus.two.rev
>
