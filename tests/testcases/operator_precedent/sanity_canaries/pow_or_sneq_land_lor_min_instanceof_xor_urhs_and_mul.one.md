...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_min_instanceof_xor_urhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor min instanceof xor urhs and mul.one
>
...
tokens (25x):
       ...
       PUNC_AND_AND IDENT PUNC_OR_OR IDENT PUNC_MIN IDENT IDENT IDENT
