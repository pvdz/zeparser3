...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_lhs_xor_lte_min_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and lhs xor lte min lor land neq or pow.one.rev
>
