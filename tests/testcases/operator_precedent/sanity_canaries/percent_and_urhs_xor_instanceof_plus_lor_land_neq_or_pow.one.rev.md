...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_instanceof_plus_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor instanceof plus lor land neq or pow.one.rev
>
...
tokens (25x):
       ...
       IDENT PUNC_AND_AND IDENT PUNC_EXCL_EQ IDENT PUNC_OR IDENT
