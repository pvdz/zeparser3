...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_min_lte_xor_urhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor min lte xor urhs and percent.one
>
