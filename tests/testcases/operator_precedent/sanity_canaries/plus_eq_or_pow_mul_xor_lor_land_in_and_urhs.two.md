...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_eq_or_pow_mul_xor_lor_land_in_and_urhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus eq or pow mul xor lor land in and urhs.two
>
