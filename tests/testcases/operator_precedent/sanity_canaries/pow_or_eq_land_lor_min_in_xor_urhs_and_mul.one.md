...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_min_in_xor_urhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor min in xor urhs and mul.one
>
