...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_instanceof_land_lor_xor_mul_pow_or_neq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and instanceof land lor xor mul pow or neq plus.two.rev
>
