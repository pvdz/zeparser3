...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_gt_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor gt min lor land eq or pow.one.rev
>
