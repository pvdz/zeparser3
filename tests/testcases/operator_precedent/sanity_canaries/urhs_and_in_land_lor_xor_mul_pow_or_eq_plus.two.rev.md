...
- Path: tests/testcases/operator_precedent/sanity_canaries/urhs_and_in_land_lor_xor_mul_pow_or_eq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> urhs and in land lor xor mul pow or eq plus.two.rev
>
