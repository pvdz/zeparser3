...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_seq_or_pow_div_xor_lor_land_gte_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min seq or pow div xor lor land gte and rhs.two
>
