...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_sneq_or_pow_mul_xor_lor_land_instanceof_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min sneq or pow mul xor lor land instanceof and lhs.two
>
