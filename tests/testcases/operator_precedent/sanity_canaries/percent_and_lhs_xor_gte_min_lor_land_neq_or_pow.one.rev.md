...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_lhs_xor_gte_min_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and lhs xor gte min lor land neq or pow.one.rev
>
