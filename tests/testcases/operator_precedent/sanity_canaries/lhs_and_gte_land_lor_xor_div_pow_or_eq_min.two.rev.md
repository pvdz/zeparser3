...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_gte_land_lor_xor_div_pow_or_eq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and gte land lor xor div pow or eq min.two.rev
>
