...
- Path: tests/testcases/operator_precedent/sanity_canaries/mul_and_urhs_xor_gt_min_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> mul and urhs xor gt min lor land sneq or pow.one.rev
>
