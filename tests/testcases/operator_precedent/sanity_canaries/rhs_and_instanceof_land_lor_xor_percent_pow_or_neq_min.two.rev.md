...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_instanceof_land_lor_xor_percent_pow_or_neq_min.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and instanceof land lor xor percent pow or neq min.two.rev
>
