...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_lhs_xor_in_plus_lor_land_sneq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and lhs xor in plus lor land sneq or pow.one.rev
>
...
tokens (25x):
       ...
       IDENT ID_in IDENT PUNC_PLUS IDENT PUNC_OR_OR IDENT PUNC_AND_AND
       IDENT PUNC_EXCL_EQ_EQ IDENT PUNC_OR IDENT PUNC_STAR_STAR IDENT
       ASI
`````
