...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_plus_lte_xor_rhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor plus lte xor rhs and mul.one
>
