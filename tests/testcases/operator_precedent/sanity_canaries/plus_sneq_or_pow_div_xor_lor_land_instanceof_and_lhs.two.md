...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_sneq_or_pow_div_xor_lor_land_instanceof_and_lhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus sneq or pow div xor lor land instanceof and lhs.two
>
...
tokens (25x):
       ...
       IDENT PUNC_AND_AND IDENT IDENT IDENT PUNC_AND IDENT PUNC_LT_LT
       IDENT ASI
`````
