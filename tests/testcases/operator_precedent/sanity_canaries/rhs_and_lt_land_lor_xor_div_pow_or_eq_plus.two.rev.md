...
- Path: tests/testcases/operator_precedent/sanity_canaries/rhs_and_lt_land_lor_xor_div_pow_or_eq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> rhs and lt land lor xor div pow or eq plus.two.rev
>
