...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_urhs_xor_in_min_lor_land_neq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and urhs xor in min lor land neq or pow.one.rev
>
