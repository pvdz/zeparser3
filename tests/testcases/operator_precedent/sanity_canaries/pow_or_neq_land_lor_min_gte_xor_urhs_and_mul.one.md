...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_neq_land_lor_min_gte_xor_urhs_and_mul.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or neq land lor min gte xor urhs and mul.one
>
