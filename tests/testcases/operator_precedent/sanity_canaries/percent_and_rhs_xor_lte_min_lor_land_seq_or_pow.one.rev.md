...
- Path: tests/testcases/operator_precedent/sanity_canaries/percent_and_rhs_xor_lte_min_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> percent and rhs xor lte min lor land seq or pow.one.rev
>
