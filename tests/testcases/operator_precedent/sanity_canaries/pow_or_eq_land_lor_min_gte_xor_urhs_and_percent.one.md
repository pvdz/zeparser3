...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_eq_land_lor_min_gte_xor_urhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or eq land lor min gte xor urhs and percent.one
>
