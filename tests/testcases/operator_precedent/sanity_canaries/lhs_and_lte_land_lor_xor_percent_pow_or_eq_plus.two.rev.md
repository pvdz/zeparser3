...
- Path: tests/testcases/operator_precedent/sanity_canaries/lhs_and_lte_land_lor_xor_percent_pow_or_eq_plus.two.rev.md

> :: operator precedent : sanity canaries
>
> ::> lhs and lte land lor xor percent pow or eq plus.two.rev
>
