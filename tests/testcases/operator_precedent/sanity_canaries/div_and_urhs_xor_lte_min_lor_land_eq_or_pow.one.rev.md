...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_urhs_xor_lte_min_lor_land_eq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and urhs xor lte min lor land eq or pow.one.rev
>
