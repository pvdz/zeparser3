...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_neq_or_pow_div_xor_lor_land_lt_and_rhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min neq or pow div xor lor land lt and rhs.two
>
