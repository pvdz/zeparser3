...
- Path: tests/testcases/operator_precedent/sanity_canaries/div_and_rhs_xor_lt_plus_lor_land_seq_or_pow.one.rev.md

> :: operator precedent : sanity canaries
>
> ::> div and rhs xor lt plus lor land seq or pow.one.rev
>
