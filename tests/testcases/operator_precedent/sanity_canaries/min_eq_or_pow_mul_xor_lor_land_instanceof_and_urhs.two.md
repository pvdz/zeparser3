...
- Path: tests/testcases/operator_precedent/sanity_canaries/min_eq_or_pow_mul_xor_lor_land_instanceof_and_urhs.two.md

> :: operator precedent : sanity canaries
>
> ::> min eq or pow mul xor lor land instanceof and urhs.two
>
