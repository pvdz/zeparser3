...
- Path: tests/testcases/operator_precedent/sanity_canaries/pow_or_sneq_land_lor_min_in_xor_rhs_and_percent.one.md

> :: operator precedent : sanity canaries
>
> ::> pow or sneq land lor min in xor rhs and percent.one
>
...
tokens (25x):
       ...
       PUNC_AND_AND IDENT PUNC_OR_OR IDENT PUNC_MIN IDENT ID_in IDENT
