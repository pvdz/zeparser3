...
- Path: tests/testcases/operator_precedent/sanity_canaries/plus_sneq_or_pow_div_xor_lor_land_lte_and_urhs.two.md

> :: operator precedent : sanity canaries
>
> ::> plus sneq or pow div xor lor land lte and urhs.two
>
...
tokens (25x):
       ...
       IDENT PUNC_AND_AND IDENT PUNC_LT_EQ IDENT PUNC_AND IDENT
