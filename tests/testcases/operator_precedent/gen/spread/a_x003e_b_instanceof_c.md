...
- Path: tests/testcases/operator_precedent/gen/spread/a_x003e_b_instanceof_c.md
...
tokens (10x):
       PUNC_BRACKET_OPEN PUNC_DOT_DOT_DOT IDENT PUNC_GT IDENT
       ID_instanceof IDENT PUNC_BRACKET_CLOSE ASI
`````
