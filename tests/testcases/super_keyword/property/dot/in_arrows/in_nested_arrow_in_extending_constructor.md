...
- Path: tests/testcases/super_keyword/property/dot/in_arrows/in_nested_arrow_in_extending_constructor.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:33},end:{line:1,column:66},source:''},
                body: [
                  {
                    type: 'ReturnStatement',
                    loc:{start:{line:1,column:35},end:{line:1,column:64},source:''},
                    argument: {
...
tokens (23x):
       ...
       PUNC_EQ_GT IDENT PUNC_DOT IDENT PUNC_SEMI PUNC_CURLY_CLOSE
       PUNC_CURLY_CLOSE
`````
