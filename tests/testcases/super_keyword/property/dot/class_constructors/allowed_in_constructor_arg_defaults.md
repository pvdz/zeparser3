...
- Path: tests/testcases/super_keyword/property/dot/class_constructors/allowed_in_constructor_arg_defaults.md
...
`````js
class x extends y { constructor(x = super.mom) { } }
`````
...
tokens (17x):
       ...
       IDENT PUNC_EQ IDENT PUNC_DOT IDENT PUNC_PAREN_CLOSE
