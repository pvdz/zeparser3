...
- Path: tests/testcases/super_keyword/property/dot/class_constructors/ok_inside_constructor_of_class_that_extends_another_class.md
...
`````js
class x extends y { constructor() { super.mom; } }
`````
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:34},end:{line:1,column:48},source:''},
                body: [
                  {
...
tokens (16x):
       ...
       PUNC_PAREN_CLOSE PUNC_CURLY_OPEN IDENT PUNC_DOT IDENT PUNC_SEMI
