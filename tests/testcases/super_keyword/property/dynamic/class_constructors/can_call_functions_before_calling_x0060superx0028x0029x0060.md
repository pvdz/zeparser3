...
- Path: tests/testcases/super_keyword/property/dynamic/class_constructors/can_call_functions_before_calling_x0060superx0028x0029x0060.md
...
`````js
class x extends y { constructor() { f(x); super[dad]; } }
`````
...
tokens (22x):
       ...
       PUNC_PAREN_CLOSE PUNC_SEMI IDENT PUNC_BRACKET_OPEN IDENT
