...
- Path: tests/testcases/super_keyword/property/dynamic/weird_places/in_class_in_class_computed_key.md
                ...
                body: [
                  {
                    ...
                    body: {
                      ...
                      body: [
                        {
                          type: 'MethodDefinition',
                          loc:{start:{line:4,column:6},end:{line:4,column:22},source:''},
                          key: {
                            type: 'MemberExpression',
                            loc:{start:{line:4,column:7},end:{line:4,column:17},source:''},
                            object: {
                              type: 'Super',
                          ...
                          value: {
                            ...
                            body: {
                              type: 'BlockStatement',
                              loc:{start:{line:4,column:20},end:{line:4,column:22},source:''},
                              body: []
                            }
                          }
                        }
