...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_no_flag/await.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi regex no flag
>
> ::> await
>
> The `/` must be parsed as a division when `await` is a var name, because it can. So no ASI
