...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_no_flag/switch.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi regex no flag
>
> ::> switch
>
> `switch` cannot be the start of a division
...
throws: Tokenizer error!
    Was looking for a paren open, found `/` (47 / 0x2f) instead
