...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_no_flag/function.md
...
throws: Tokenizer error!
    Was looking for an ident, star, or closing paren, found `/` (47 / 0x2f) instead
