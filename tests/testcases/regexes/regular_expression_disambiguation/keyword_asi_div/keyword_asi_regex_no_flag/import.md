...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_no_flag/import.md
...
throws: Tokenizer error!
    Was looking for an ident, `*`, `{`, `(`, or string, found `/` (47 / 0x2f) instead
