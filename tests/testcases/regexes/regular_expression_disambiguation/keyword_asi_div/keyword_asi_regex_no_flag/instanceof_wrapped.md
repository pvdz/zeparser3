...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_no_flag/instanceof_wrapped.md
...
tokens (5x):
       IDENT ID_instanceof REGEXN ASI
`````
