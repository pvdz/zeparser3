...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_div/debugger.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi div
>
> ::> debugger
>
> The `debugger` is never part of a division so this fails
