...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_div/await_wrapped.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi div
>
> ::> await wrapped
>
> The `await` is a keyword in this context so `/` is never parsed as a division
