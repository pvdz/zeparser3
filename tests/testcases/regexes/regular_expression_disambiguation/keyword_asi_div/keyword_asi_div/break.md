...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_div/break.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi div
>
> ::> break
>
> The `break` is never the start of a division so should always be regex so this fails
