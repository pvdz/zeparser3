...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_div/await.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi div
>
> ::> await
>
> The `await` is a var in this context (except in module goal) so `/` is parsed as a division
