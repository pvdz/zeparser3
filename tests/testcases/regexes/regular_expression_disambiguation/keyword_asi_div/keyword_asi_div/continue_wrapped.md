...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_div/continue_wrapped.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi div
>
> ::> continue wrapped
>
> The `continue` is never part of a division so this fails
