...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_flag/package.md
...
tokens (7x):
       ID_package PUNC_DIV IDENT PUNC_DIV IDENT ASI
`````
