...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_flag/null.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi regex flag
>
> ::> null
>
> Just a division, what could go wrong
...
tokens (7x):
       ID_null PUNC_DIV IDENT PUNC_DIV IDENT ASI
`````
