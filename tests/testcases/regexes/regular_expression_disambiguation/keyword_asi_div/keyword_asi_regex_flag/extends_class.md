...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_flag/extends_class.md
...
tokens (7x):
       IDENT IDENT IDENT REGEXN PUNC_CURLY_OPEN PUNC_CURLY_CLOSE
`````
