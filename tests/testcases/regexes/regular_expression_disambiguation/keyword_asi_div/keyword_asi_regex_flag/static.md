...
- Path: tests/testcases/regexes/regular_expression_disambiguation/keyword_asi_div/keyword_asi_regex_flag/static.md

> :: regexes : regular expression disambiguation : keyword asi div : keyword asi regex flag
>
> ::> static
>
> `static` is never the start of a division
...
tokens (7x):
       ID_static PUNC_DIV IDENT PUNC_DIV IDENT ASI
`````
