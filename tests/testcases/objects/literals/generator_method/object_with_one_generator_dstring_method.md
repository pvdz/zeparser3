...
- Path: tests/testcases/objects/literals/generator_method/object_with_one_generator_dstring_method.md
...
tokens (13x):
       IDENT PUNC_PAREN_OPEN PUNC_CURLY_OPEN PUNC_STAR STRING_DOUBLE
