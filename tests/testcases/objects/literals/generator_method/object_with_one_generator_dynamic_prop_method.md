...
- Path: tests/testcases/objects/literals/generator_method/object_with_one_generator_dynamic_prop_method.md

> :: objects : literals : generator method
>
> ::> object with one generator dynamic prop method
...
tokens (15x):
       IDENT PUNC_PAREN_OPEN PUNC_CURLY_OPEN PUNC_STAR
