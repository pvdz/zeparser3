...
- Path: tests/testcases/objects/literals/async_method/object_with_one_async_method_2.md

> :: objects : literals : async method
>
> ::> object with one async method 2
...
tokens (15x):
       IDENT PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_async
