...
- Path: tests/testcases/objects/literals/async_method/object_with_one_async_method_get.md

> :: objects : literals : async method
>
> ::> object with one async method get
...
tokens (13x):
       IDENT PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_async ID_get
