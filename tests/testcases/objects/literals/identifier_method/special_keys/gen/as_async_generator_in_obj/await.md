...
- Path: tests/testcases/objects/literals/identifier_method/special_keys/gen/as_async_generator_in_obj/await.md
        ...
        properties: [
          {
            ...
            key: {
              type: 'Identifier',
              loc:{start:{line:2,column:10},end:{line:2,column:15},source:''},
              name: 'await'
            },
            kind: 'init',
            method: true,
...
tokens (13x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_async PUNC_STAR ID_await
