...
- Path: tests/testcases/objects/literals/identifier_method/special_keys/gen/as_async_generator_in_obj/instanceof.md

> :: objects : literals : identifier method : special keys : gen : as async generator in obj
>
> ::> instanceof
        ...
        properties: [
          {
            ...
            key: {
              type: 'Identifier',
              loc:{start:{line:2,column:10},end:{line:2,column:20},source:''},
              name: 'instanceof'
            },
            kind: 'init',
            method: true,
...
tokens (13x):
       ...
       ID_instanceof PUNC_PAREN_OPEN PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
