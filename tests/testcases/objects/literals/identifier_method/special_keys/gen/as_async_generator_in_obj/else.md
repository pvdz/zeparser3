...
- Path: tests/testcases/objects/literals/identifier_method/special_keys/gen/as_async_generator_in_obj/else.md
...
tokens (13x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_async PUNC_STAR ID_else
