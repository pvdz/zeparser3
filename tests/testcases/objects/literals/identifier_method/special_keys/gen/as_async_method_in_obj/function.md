...
- Path: tests/testcases/objects/literals/identifier_method/special_keys/gen/as_async_method_in_obj/function.md
        ...
        properties: [
          {
            ...
            key: {
              type: 'Identifier',
              loc:{start:{line:2,column:8},end:{line:2,column:16},source:''},
              name: 'function'
            },
            kind: 'init',
            method: true,
...
tokens (12x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_async ID_function
