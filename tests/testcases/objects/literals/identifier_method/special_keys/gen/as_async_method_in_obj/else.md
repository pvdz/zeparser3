...
- Path: tests/testcases/objects/literals/identifier_method/special_keys/gen/as_async_method_in_obj/else.md
...
tokens (12x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_async ID_else
