...
- Path: tests/testcases/objects/literals/identifier_method/special_keys_with_identx003dawait/as_getter_in_obj.md
...
tokens (12x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_get ID_await PUNC_PAREN_OPEN
