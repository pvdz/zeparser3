...
- Path: tests/testcases/objects/keywords_should_not_parse_as_regular_idents_in_awkward_places/gen/destructuring_assignment_as_shorthand/x_x002b_y.md
...
`````
throws: Parser error!
  Unexpected character after object literal property name {# PUNC_PLUS : nl=N ws=N pos=4:5 loc=4:1 curc=43 `+`#}
