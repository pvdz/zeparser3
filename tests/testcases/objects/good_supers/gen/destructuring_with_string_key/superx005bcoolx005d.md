...
- Path: tests/testcases/objects/good_supers/gen/destructuring_with_string_key/superx005bcoolx005d.md
                ...
                body: [
                  {
                    ...
                    loc:{start:{line:3,column:4},end:{line:3,column:30},source:''},
                    expression: {
                      type: 'AssignmentExpression',
                      loc:{start:{line:3,column:5},end:{line:3,column:29},source:''},
                      left: {
                        type: 'ObjectPattern',
                      ...
                      right: {
                        type: 'Identifier',
                        loc:{start:{line:3,column:28},end:{line:3,column:29},source:''},
                        name: 'x'
                      }
                    }
                  }
...
tokens (25x):
       ...
       PUNC_CURLY_OPEN STRING_DOUBLE PUNC_COLON IDENT
