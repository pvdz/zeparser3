...
- Path: tests/testcases/objects/destructuring/destruct_assignment_when_value_is_property_of_number.md
...
tokens (13x):
       ...
       NUMBER_DEC PUNC_DOT IDENT PUNC_CURLY_CLOSE PUNC_EQ IDENT
