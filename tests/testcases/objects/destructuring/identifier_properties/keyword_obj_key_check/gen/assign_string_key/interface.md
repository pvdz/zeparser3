...
- Path: tests/testcases/objects/destructuring/identifier_properties/keyword_obj_key_check/gen/assign_string_key/interface.md
...
tokens (11x):
       ...
       ID_interface PUNC_CURLY_CLOSE PUNC_EQ ID_null PUNC_PAREN_CLOSE
       ASI
`````
