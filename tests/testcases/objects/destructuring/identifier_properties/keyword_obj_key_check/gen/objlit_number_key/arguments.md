...
- Path: tests/testcases/objects/destructuring/identifier_properties/keyword_obj_key_check/gen/objlit_number_key/arguments.md
...
tokens (9x):
       ...
       ID_arguments PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE ASI
`````
