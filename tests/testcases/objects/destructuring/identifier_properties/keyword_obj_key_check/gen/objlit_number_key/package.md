...
- Path: tests/testcases/objects/destructuring/identifier_properties/keyword_obj_key_check/gen/objlit_number_key/package.md
...
tokens (9x):
       ...
       ID_package PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE ASI
`````
