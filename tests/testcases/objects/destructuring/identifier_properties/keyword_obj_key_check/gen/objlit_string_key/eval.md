...
- Path: tests/testcases/objects/destructuring/identifier_properties/keyword_obj_key_check/gen/objlit_string_key/eval.md
...
tokens (9x):
       ...
       ID_eval PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE ASI
`````
