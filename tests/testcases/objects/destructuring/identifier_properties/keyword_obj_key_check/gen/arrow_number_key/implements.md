...
- Path: tests/testcases/objects/destructuring/identifier_properties/keyword_obj_key_check/gen/arrow_number_key/implements.md
...
tokens (11x):
       ...
       ID_implements PUNC_CURLY_CLOSE PUNC_PAREN_CLOSE PUNC_EQ_GT
       ID_null ASI
`````
