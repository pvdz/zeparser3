...
- Path: tests/testcases/objects/destructuring/identifier_properties/shorthand_identifiers_check/strict-mode_only_keywordx003dprivate.md

> :: objects : destructuring : identifier properties : shorthand identifiers check
>
> ::> strict-mode only keywordx003dprivate
...
tokens (9x):
       PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_private PUNC_CURLY_CLOSE
