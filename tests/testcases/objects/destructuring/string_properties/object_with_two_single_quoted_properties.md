...
- Path: tests/testcases/objects/destructuring/string_properties/object_with_two_single_quoted_properties.md

> :: objects : destructuring : string properties
>
> ::> object with two single quoted properties
...
tokens (16x):
       ...
       IDENT PUNC_COMMA STRING_SINGLE PUNC_COLON IDENT
