...
- Path: tests/testcases/objects/duplicate_keys/obj_expr/dunderproto___proto__/bad_case_with_ident_and_string.md
...
tokens (13x):
       ...
       PUNC_COMMA STRING_DOUBLE PUNC_COLON NUMBER_DEC PUNC_CURLY_CLOSE
       ASI
`````
