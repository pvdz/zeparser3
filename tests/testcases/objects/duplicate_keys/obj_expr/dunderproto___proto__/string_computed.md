...
- Path: tests/testcases/objects/duplicate_keys/obj_expr/dunderproto___proto__/string_computed.md
...
tokens (15x):
       IDENT PUNC_EQ PUNC_CURLY_OPEN PUNC_BRACKET_OPEN STRING_DOUBLE
       PUNC_BRACKET_CLOSE PUNC_COLON NUMBER_DEC PUNC_COMMA IDENT
       PUNC_COLON NUMBER_DEC PUNC_CURLY_CLOSE ASI
`````
