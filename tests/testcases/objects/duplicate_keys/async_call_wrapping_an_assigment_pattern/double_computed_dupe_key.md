...
- Path: tests/testcases/objects/duplicate_keys/async_call_wrapping_an_assigment_pattern/double_computed_dupe_key.md
...
tokens (20x):
       ...
       IDENT PUNC_BRACKET_CLOSE PUNC_COLON IDENT PUNC_COMMA
