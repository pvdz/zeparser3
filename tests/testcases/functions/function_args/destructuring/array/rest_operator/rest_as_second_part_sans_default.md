...
- Path: tests/testcases/functions/function_args/destructuring/array/rest_operator/rest_as_second_part_sans_default.md
...
tokens (13x):
       ...
       PUNC_DOT_DOT_DOT IDENT PUNC_BRACKET_CLOSE PUNC_PAREN_CLOSE
