...
- Path: tests/testcases/functions/function_args/destructuring/array/rest_operator/simple_rest_arg_with_default.md
...
tokens (13x):
       IDENT IDENT PUNC_PAREN_OPEN PUNC_BRACKET_OPEN PUNC_DOT_DOT_DOT
