...
- Path: tests/testcases/functions/function_args/destructuring/array/double_ident_in_array_with_default_and_sans_default_with_default.md
...
tokens (16x):
       ...
       PUNC_EQ IDENT PUNC_COMMA IDENT PUNC_BRACKET_CLOSE PUNC_EQ IDENT
