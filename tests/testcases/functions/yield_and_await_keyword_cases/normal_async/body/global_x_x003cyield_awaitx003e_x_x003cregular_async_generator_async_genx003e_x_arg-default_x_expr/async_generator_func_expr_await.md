...
- Path: tests/testcases/functions/yield_and_await_keyword_cases/normal_async/body/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_arg-default_x_expr/async_generator_func_expr_await.md
...
tokens (24x):
       ...
       IDENT PUNC_SEMI PUNC_CURLY_CLOSE ASI PUNC_CURLY_CLOSE
`````
