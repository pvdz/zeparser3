...
- Path: tests/testcases/functions/yield_and_await_keyword_cases/normal_async/arg-name/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_arg-name_x_expr/async_func_expr_arg_called_yield.md
  ...
  body: [
    {
      ...
      body: {
        type: 'BlockStatement',
        loc:{start:{line:1,column:19},end:{line:1,column:57},source:''},
        body: [
          {
            type: 'VariableDeclaration',
            loc:{start:{line:1,column:21},end:{line:1,column:55},source:''},
            kind: 'let',
            declarations: [
              {
                ...
                init: {
                  ...
                  loc:{start:{line:1,column:29},end:{line:1,column:55},source:''},
                  generator: false,
                  async: true,
                  id: {
                    type: 'Identifier',
...
tokens (20x):
       ...
       PUNC_CURLY_OPEN IDENT IDENT PUNC_EQ IDENT IDENT IDENT
