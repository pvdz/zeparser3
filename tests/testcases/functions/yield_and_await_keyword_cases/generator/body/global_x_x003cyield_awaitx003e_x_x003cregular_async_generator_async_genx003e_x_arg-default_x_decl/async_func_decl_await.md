...
- Path: tests/testcases/functions/yield_and_await_keyword_cases/generator/body/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_arg-default_x_decl/async_func_decl_await.md
  ...
  body: [
    {
      ...
      body: {
        type: 'BlockStatement',
        loc:{start:{line:1,column:14},end:{line:1,column:58},source:''},
        body: [
          {
            type: 'FunctionDeclaration',
            loc:{start:{line:1,column:16},end:{line:1,column:56},source:''},
            generator: false,
            async: true,
            id: {
              type: 'Identifier',
