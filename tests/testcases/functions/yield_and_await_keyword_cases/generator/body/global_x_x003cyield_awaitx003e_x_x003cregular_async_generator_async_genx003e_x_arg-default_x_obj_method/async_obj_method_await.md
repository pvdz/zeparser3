...
- Path: tests/testcases/functions/yield_and_await_keyword_cases/generator/body/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_arg-default_x_obj_method/async_obj_method_await.md
        ...
        body: [
          {
            ...
            loc:{start:{line:1,column:16},end:{line:1,column:53},source:''},
            expression: {
              ...
              right: {
                ...
                properties: [
                  {
                    type: 'Property',
                    loc:{start:{line:1,column:21},end:{line:1,column:52},source:''},
                    key: {
                      type: 'Identifier',
...
tokens (23x):
       ...
       PUNC_CURLY_OPEN IDENT PUNC_EQ PUNC_CURLY_OPEN IDENT IDENT
