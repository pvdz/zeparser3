...
- Path: tests/testcases/functions/expression/rest/support_rest_arg_with_other_args.md

> :: functions : expression : rest
>
> ::> support rest arg with other args
...
tokens (13x):
       ...
       PUNC_DOT_DOT_DOT IDENT PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
       PUNC_CURLY_CLOSE
`````
