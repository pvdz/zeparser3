...
- Path: tests/testcases/functions/pattern_with_shorthand_and_init_nested_in_dynamic_property.md
...
tokens (18x):
       IDENT IDENT PUNC_PAREN_OPEN PUNC_CURLY_OPEN PUNC_BRACKET_OPEN
       IDENT PUNC_BRACKET_CLOSE PUNC_COLON PUNC_CURLY_OPEN IDENT
       PUNC_EQ IDENT PUNC_CURLY_CLOSE PUNC_CURLY_CLOSE
