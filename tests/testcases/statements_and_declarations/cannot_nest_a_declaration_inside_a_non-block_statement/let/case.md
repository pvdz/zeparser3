...
- Path: tests/testcases/statements_and_declarations/cannot_nest_a_declaration_inside_a_non-block_statement/let/case.md
...
tokens (15x):
       ...
       PUNC_CURLY_OPEN ID_case IDENT PUNC_COLON ID_let IDENT PUNC_EQ
