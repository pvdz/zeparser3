...
- Path: tests/testcases/statements_and_declarations/cannot_nest_a_declaration_inside_a_non-block_statement/let/default.md
...
tokens (14x):
       ...
       IDENT PUNC_COLON IDENT IDENT PUNC_EQ IDENT ASI PUNC_CURLY_CLOSE
`````
