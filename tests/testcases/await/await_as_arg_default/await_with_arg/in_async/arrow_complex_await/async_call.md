...
- Path: tests/testcases/await/await_as_arg_default/await_with_arg/in_async/arrow_complex_await/async_call.md
...
tokens (27x):
       ...
       PUNC_PLUS IDENT PUNC_PAREN_OPEN IDENT IDENT PUNC_PAREN_CLOSE
