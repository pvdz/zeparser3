...
- Path: tests/testcases/await/await_as_arg_default/await_with_arg/in_async/arrow_just_an_await/async_destruct_arr_call.md
...
tokens (18x):
       ...
       PUNC_CURLY_OPEN IDENT PUNC_PAREN_OPEN PUNC_BRACKET_OPEN IDENT
       PUNC_BRACKET_CLOSE PUNC_EQ IDENT IDENT PUNC_PAREN_CLOSE
