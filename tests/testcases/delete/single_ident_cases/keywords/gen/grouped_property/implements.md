...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/grouped_property/implements.md
...
tokens (8x):
       IDENT PUNC_PAREN_OPEN IDENT PUNC_DOT IDENT PUNC_PAREN_CLOSE ASI
`````
