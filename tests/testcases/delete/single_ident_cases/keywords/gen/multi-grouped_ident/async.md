...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/async.md
...
tokens (10x):
       ...
       ID_async PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE ASI
`````
