...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/protected.md
...
tokens (10x):
       ...
       ID_protected PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE
       ASI
`````
