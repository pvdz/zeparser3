...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/await.md
...
tokens (10x):
       ...
       ID_await PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE ASI
`````
