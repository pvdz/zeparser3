...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/yield.md
...
tokens (10x):
       ...
       ID_yield PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE ASI
`````
