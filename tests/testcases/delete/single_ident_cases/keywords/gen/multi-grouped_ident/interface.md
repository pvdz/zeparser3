...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/interface.md
...
tokens (10x):
       ...
       ID_interface PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE
       ASI
`````
