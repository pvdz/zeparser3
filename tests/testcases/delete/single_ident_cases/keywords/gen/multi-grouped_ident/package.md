...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/package.md
...
tokens (10x):
       ...
       ID_package PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE
       ASI
`````
