...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_ident/false.md
...
tokens (10x):
       ...
       ID_false PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE ASI
`````
