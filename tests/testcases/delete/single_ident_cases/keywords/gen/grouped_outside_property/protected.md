...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/grouped_outside_property/protected.md
...
tokens (8x):
       IDENT PUNC_PAREN_OPEN IDENT PUNC_PAREN_CLOSE PUNC_DOT IDENT ASI
`````
