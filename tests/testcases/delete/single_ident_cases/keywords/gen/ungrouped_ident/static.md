...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/ungrouped_ident/static.md
...
`````
throws: Parser error!
  Cannot use this name (static) as a variable name because: `static` is a reserved word in strict mode (at EOF)
