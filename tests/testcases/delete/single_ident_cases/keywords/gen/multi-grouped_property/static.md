...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_property/static.md
...
tokens (12x):
       ...
       ID_static PUNC_DOT IDENT PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE
