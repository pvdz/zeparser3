...
- Path: tests/testcases/delete/single_ident_cases/keywords/gen/multi-grouped_property/arguments.md
...
tokens (12x):
       ...
       ID_arguments PUNC_DOT IDENT PUNC_PAREN_CLOSE PUNC_PAREN_CLOSE
