...
- Path: tests/testcases/dowhile_statement/asi_problem_case_that_almost_all_parsers_seem_to_accept/debugger_with_semi.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# IDENT : nl=N ws=N pos=22:23 loc=22:1 curc=120 `x`#}
