...
- Path: tests/testcases/templates/bad_escapes/in_body/only_okay_in_tagged_templates_in_es9/check_illegal_escapes_in_infinity_mode.md
...
tokens (8x):
       IDENT TICK_HEAD IDENT TICK_BAD_BODY IDENT TICK_TAIL PUNCTUATOR
`````
