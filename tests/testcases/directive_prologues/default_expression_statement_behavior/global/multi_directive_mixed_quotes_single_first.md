...
- Path: tests/testcases/directive_prologues/default_expression_statement_behavior/global/multi_directive_mixed_quotes_single_first.md
...
tokens (5x):
       STRING_SINGLE PUNC_SEMI STRING_DOUBLE PUNC_SEMI
`````
