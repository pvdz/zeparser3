...
- Path: tests/testcases/directive_prologues/default_expression_statement_behavior/function_variations/check_node_with_paren-less_arrow.md
...
tokens (8x):
       IDENT PUNC_EQ_GT PUNC_CURLY_OPEN STRING_DOUBLE PUNC_SEMI
