...
- Path: tests/testcases/directive_prologues/default_expression_statement_behavior/regular_function/single_directive_single_string.md
...
tokens (9x):
       ...
       PUNC_CURLY_OPEN STRING_SINGLE PUNC_SEMI PUNC_CURLY_CLOSE
`````
