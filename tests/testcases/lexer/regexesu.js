let {PARSE_MODE_REGEX} = require('../../utils');

let {$ERROR, $IDENT, $REGEXU} = require('../../../src/zetokenizer'); // nodejs doesnt support import and wont for a while, it seems (https://medium.com/the-node-js-collection/an-update-on-es6-modules-in-node-js-42c958b890c)

let regexesu = [
  // pretty much the same as regexes except all regexes should have the u flag (causes regex to parse code points instead of code units and requires slightly different syntax)
  ...
  [
    [`/a{11,15}/u`, `/a{12,26}/u`, `/a{23,37}/u`, `/a{34,48}/u`, `/a{45,59}/u`, `/a{56,60}/u`, `/a{67,71}/u`, `/a{78,82}/u`, `/a{89,93}/u`, `/a{90,94}/u`],
    $REGEXU,
    PARSE_MODE_REGEX,
  ],
  [[`/a{,0}/u`, `/a{,1}/u`, `/a{,2}/u`, `/a{,3}/u`, `/a{,4}/u`, `/a{,5}/u`, `/a{,6}/u`, `/a{,7}/u`, `/a{,8}/u`, `/a{,9}/u`], $REGEXU, PARSE_MODE_REGEX],
  ...
  [
    ['/a{ 1}/u', '/a{1 }/u', '/a{1, 1}/u', '/a{ 1, 1}/u', '/a{1 ,1}/u', '/a{ 1 , 1}/u', '/a{1,1 }/u', '/a{1, 1 }/u', '/a{ 1, 1 }/u', '/a{ 1 , 1 }/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ['/abc\\d/u', '/abc\\D/u', '/abc\\f/u', '/abc\\n/u', '/abc\\r/u', '/abc\\s/u', '/abc\\S/u', '/abc\\t/u', '/abc\\v/u', '/abc\\w/u', '/abc\\W/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
    'escaping a prefixed single letter',
  ],
  [
    ['/\\fabcd/u', '/\\dabcd/u', '/\\Dabcd/u', '/\\nabcd/u', '/\\rabcd/u', '/\\sabcd/u', '/\\Sabcd/u', '/\\tabcd/u', '/\\vabcd/u', '/\\wabcd/u', '/\\Wabcd/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
  ...
  [
    ['/\\a/u', '/\\e/u', '/\\g/u', '/\\h/u', '/\\i/u', '/\\j/u', '/\\k/u', '/\\l/u', '/\\m/u', '/\\o/u', '/\\p/u', '/\\q/u', '/\\u/u', '/\\x/u', '/\\y/u', '/\\z/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ['/\\x/u', '/\\x0/u', '/\\x1/u', '/\\x2/u', '/\\x3/u', '/\\x4/u', '/\\x5/u', '/\\x6/u', '/\\x7/u', '/\\x8/u', '/\\x9/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ['/\\01/u', '/a\\02/u', '/\\03b/u', '/a\\04b/u', '/(a)\\05/u', '/\\06(b)/u', '/(\\07)/u', '/\\08/u', '/\\09/u', '/\\00/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ['/\\1(a)/u', '/(a)\\1/u', '/(\\1)/u', '/\\1x(a)/u', '/(a)x\\1/u', '/(a\\1b)/u', '/0\\1(a)/u', '/4\\1(a)/u', '/(a)|\\1/u', '/\\1|(a)/u', '/(\\1|a)/u', '/(a|\\1)/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
  ...
  [
    ['/\\2(a)/u', '/(a)\\3/u', '/(\\4)/u', '/\\5x(a)/u', '/(a)x\\6/u', '/(a\\7b)/u', '/0\\8(a)/u', '/4\\9(a)/u', '/(a)|\\10/u', '/\\11|(a)/u', '/(\\12|a)/u', '/(a|\\13)/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ['/[\\90]/u', '/[\\12]/u', '/[\\23]/u', '/[\\34]/u', '/[\\45]/u', '/[\\56]/u', '/[\\67]/u', '/[\\78]/u', '/[\\89]/u', '/[\\91]/u'],
    $ERROR,
    PARSE_MODE_REGEX,
    'non-zero digit escapes are illegal in char class',
  ],
  ...
  [
    ['/[\\x01]/u', '/[\\xa2]/u', '/[\\xF3]/u', '/[\\x34]/u', '/[\\xC5]/u', '/[\\x5a]/u', '/[\\x67]/u', '/[\\x7D]/u', '/[\\x8f]/u', '/[\\x90]/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
    'valid hex escapes',
  ],
  [
    ['/[\\xa1]/u', '/[\\xb2]/u', '/[\\xc3]/u', '/[\\x3d]/u', '/[\\x4e]/u', '/[\\x5f]/u', '/[\\x6A]/u', '/[\\xbB]/u', '/[\\xCD]/u', '/[\\xEF]/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
    'valid hex escapes',
  ],
  ...
  [
    ['/[\\u1234\\u1234\\udc00]/u', '/[x\\u0567\\u0567\\udc10]/u', '/[\\uf89a\\uf89a\\udd00y]/u', '/[x\\ubcde\\ubcde\\udebcy]/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
    'non + non + trail pair',
  ],
  [
    ['/[\\u1234\\udc00\\udc00]/u', '/[x\\u0567\\udc10\\udc10]/u', '/[\\uf89a\\udd00\\udd00y]/u', '/[x\\ubcde\\udebc\\udebcy]/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
  ...
  [`/[\\u{0000000000000000000010ffff}]/u`, $REGEXU, PARSE_MODE_REGEX, 'must take care that the hex may still have any number of leading zeroes'],
  [
    [`/[\\u{00000000000000000000110000}]/u`, `/[\\u{00000000000000000000120000}]/u`, `/[\\u{0000000000123456789}]/u`, `/[\\u{000000ffffffffffffffff}]/u`],
    $ERROR,
    PARSE_MODE_REGEX,
    'must take care that the hex may still have any number of leading zeroes',
  ],
  [
    ['/[\\da-z]/u', '/[\\DA-Z]/u', '/[\\sa-z]/u', '/[\\SA-S]/u', '/[\\wa-z]/u', '/[\\WA-Z]/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
  ...
  [
    ['/[x\\d-z]/u', '/[x\\D-Z]/u', '/[x\\s-z]/u', '/[x\\S-S]/u', '/[x\\w-z]/u', '/[x\\W-Z]/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ['/[a-z\\dx]/u', '/[A-Z\\Dx]/u', '/[a-z\\sx]/u', '/[A-S\\Sx]/u', '/[a-z\\wx]/u', '/[A-Z\\Wx]/u'],
    $REGEXU,
    PARSE_MODE_REGEX,
    'with suffix class escapes are also valid in char classes that contain ranges',
  ],
  [
    ['/[a-\\dx]/u', '/[A-\\Dx]/u', '/[a-\\sx]/u', '/[A-\\Sx]/u', '/[a-\\wx]/u', '/[A-\\Wx]/u'],
    $ERROR,
    PARSE_MODE_REGEX,
  ...
  [
    ...
    $REGEXU,
    PARSE_MODE_REGEX,
    'a range that starts and ends with a dash and then followed by a single character that is also a dash and ends with a dash because they cant make another range',
  ],
  ...
  [['/(?=.)*/u', '/(?=.)+/u', '/(?=.)?/u', '/(?=.){1}/u', '/(?!.)*/u', '/(?!.)+/u', '/(?!.)?/u', '/(?!.){1}/u'], $REGEXU, PARSE_MODE_REGEX, 'leading quantifier'],
  [
    [
      '/\\b*/u',
      '/\\b+/u',
