...
- Path: tests/testcases/classes/dynamic_methods/async_with_dynamic_key_1.md

> :: classes : dynamic methods
>
> ::> async with dynamic key 1
...
tokens (13x):
       ID_class IDENT PUNC_CURLY_OPEN ID_async PUNC_BRACKET_OPEN IDENT
