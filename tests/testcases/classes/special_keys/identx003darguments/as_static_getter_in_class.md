...
- Path: tests/testcases/classes/special_keys/identx003darguments/as_static_getter_in_class.md
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_get ID_arguments
