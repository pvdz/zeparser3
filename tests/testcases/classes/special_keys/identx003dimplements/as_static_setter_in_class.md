...
- Path: tests/testcases/classes/special_keys/identx003dimplements/as_static_setter_in_class.md
...
tokens (13x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_set ID_implements
