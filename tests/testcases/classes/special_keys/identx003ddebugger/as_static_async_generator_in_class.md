...
- Path: tests/testcases/classes/special_keys/identx003ddebugger/as_static_async_generator_in_class.md

> :: classes : special keys : identx003ddebugger
>
        ...
        body: [
          {
            ...
            key: {
              type: 'Identifier',
              loc:{start:{line:1,column:24},end:{line:1,column:32},source:''},
              name: 'debugger'
            },
            static: true,
            computed: false,
...
tokens (13x):
       ...
       ID_debugger PUNC_PAREN_OPEN PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
