...
- Path: tests/testcases/classes/special_keys/identx003dbreak/as_static_async_method_in_class.md
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static ID_async ID_break
