...
- Path: tests/testcases/classes/special_keys/gen/as_static_generator_in_class/interface.md
...
tokens (12x):
       ID_class IDENT PUNC_CURLY_OPEN ID_static PUNC_STAR ID_interface
