...
- Path: tests/testcases/classes/piggies_in_classes/super_ident/wrapped_in_extending_class_in_method/method_key.md
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,column:22},end:{line:1,column:57},source:''},
        body: [
          {
