...
- Path: tests/testcases/classes/piggies_in_classes/super_ident/wrapped_in_extending_class_in_constructor/method_key.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:37},end:{line:1,column:64},source:''},
                body: [
                  {
                    type: 'ClassDeclaration',
