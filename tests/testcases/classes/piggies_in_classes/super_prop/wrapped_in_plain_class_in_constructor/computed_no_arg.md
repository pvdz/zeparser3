...
- Path: tests/testcases/classes/piggies_in_classes/super_prop/wrapped_in_plain_class_in_constructor/computed_no_arg.md
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,column:12},end:{line:1,column:61},source:''},
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:27},end:{line:1,column:60},source:''},
                body: [
                  {
                    type: 'ClassDeclaration',
                    loc:{start:{line:1,column:30},end:{line:1,column:57},source:''},
                    id: {
                      type: 'Identifier',
