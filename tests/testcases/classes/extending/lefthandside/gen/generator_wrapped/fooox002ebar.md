...
- Path: tests/testcases/classes/extending/lefthandside/gen/generator_wrapped/fooox002ebar.md
...
tokens (16x):
       ...
       PUNC_CURLY_OPEN ID_class IDENT ID_extends IDENT PUNC_DOT IDENT
