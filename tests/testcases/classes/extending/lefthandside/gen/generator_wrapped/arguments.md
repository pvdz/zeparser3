...
- Path: tests/testcases/classes/extending/lefthandside/gen/generator_wrapped/arguments.md
...
tokens (14x):
       ...
       PUNC_CURLY_OPEN IDENT IDENT IDENT IDENT PUNC_CURLY_OPEN
...
````js
function* P() {class D extends (arguments) {}}
````
