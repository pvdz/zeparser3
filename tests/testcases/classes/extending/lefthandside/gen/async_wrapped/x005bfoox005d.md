...
- Path: tests/testcases/classes/extending/lefthandside/gen/async_wrapped/x005bfoox005d.md
...
tokens (16x):
       ...
       PUNC_CURLY_OPEN IDENT IDENT IDENT PUNC_BRACKET_OPEN IDENT
...
````js
async function p() {class C extends ([foo,]) {}}
````
