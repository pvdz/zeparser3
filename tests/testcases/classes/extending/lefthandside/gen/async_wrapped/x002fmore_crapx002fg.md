...
- Path: tests/testcases/classes/extending/lefthandside/gen/async_wrapped/x002fmore_crapx002fg.md
        ...
        body: [
          {
            ...
            loc:{start:{line:2,column:2},end:{line:2,column:33},source:''},
            id: {
              type: 'Identifier',
            ...
            superClass: {
              type: 'Literal',
              loc:{start:{line:2,column:18},end:{line:2,column:30},source:''},
              value: null,
...
tokens (14x):
       ...
       PUNC_CURLY_OPEN IDENT IDENT IDENT REGEXN PUNC_CURLY_OPEN
...
````js
async function p() {class C extends (/more crap/g) {}}
````
