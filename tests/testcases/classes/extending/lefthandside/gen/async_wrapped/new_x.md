...
- Path: tests/testcases/classes/extending/lefthandside/gen/async_wrapped/new_x.md
...
tokens (15x):
       ...
       PUNC_CURLY_OPEN IDENT IDENT IDENT IDENT IDENT PUNC_CURLY_OPEN
...
````js
async function p() {class C extends (new (x)()) {}}
````
