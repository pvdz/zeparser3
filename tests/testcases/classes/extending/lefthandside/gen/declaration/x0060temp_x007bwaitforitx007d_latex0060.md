...
- Path: tests/testcases/classes/extending/lefthandside/gen/declaration/x0060temp_x007bwaitforitx007d_latex0060.md
...
tokens (7x):
       IDENT IDENT IDENT TICK_PURE PUNC_CURLY_OPEN PUNC_CURLY_CLOSE
`````
