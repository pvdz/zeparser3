...
- Path: tests/testcases/exponentiation_op/statement/new_is_allowed_as_lhs_or_well_new_takes_x002ax002a_as_arg_but_whatever.md
...
tokens (6x):
       IDENT IDENT PUNC_STAR_STAR NUMBER_DEC PUNC_SEMI
`````
