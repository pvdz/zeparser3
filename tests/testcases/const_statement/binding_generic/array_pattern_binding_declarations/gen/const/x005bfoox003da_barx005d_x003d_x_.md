...
- Path: tests/testcases/const_statement/binding_generic/array_pattern_binding_declarations/gen/const/x005bfoox003da_barx005d_x003d_x_.md

> :: const statement : binding generic : array pattern binding declarations : gen : const
>
> ::> x005bfoox003da barx005d x003d x
...
tokens (12x):
       IDENT PUNC_BRACKET_OPEN IDENT PUNC_EQ IDENT PUNC_COMMA IDENT
