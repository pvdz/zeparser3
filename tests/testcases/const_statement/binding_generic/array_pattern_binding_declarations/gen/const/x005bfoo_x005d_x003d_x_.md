...
- Path: tests/testcases/const_statement/binding_generic/array_pattern_binding_declarations/gen/const/x005bfoo_x005d_x003d_x_.md

> :: const statement : binding generic : array pattern binding declarations : gen : const
>
> ::> x005bfoo x005d x003d x
...
tokens (10x):
       ID_const PUNC_BRACKET_OPEN IDENT PUNC_COMMA PUNC_COMMA
