...
- Path: tests/testcases/const_statement/binding_generic/in_export_decl/destructuring/array/two_vars_with_and_without_initializer.md
...
tokens (13x):
       IDENT IDENT PUNC_BRACKET_OPEN IDENT PUNC_EQ IDENT PUNC_COMMA
