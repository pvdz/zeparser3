...
- Path: tests/testcases/const_statement/binding_generic/in_export_decl/destructuring/array/rest_operator/rest_as_the_only_destruct.md
...
tokens (10x):
       ID_export ID_const PUNC_BRACKET_OPEN PUNC_DOT_DOT_DOT IDENT
