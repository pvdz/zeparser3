...
- Path: tests/testcases/const_statement/binding_generic/in_export_decl/destructuring/object/empty_obj.md
...
tokens (8x):
       IDENT IDENT PUNC_CURLY_OPEN PUNC_CURLY_CLOSE PUNC_EQ IDENT
       PUNC_SEMI
`````
