...
- Path: tests/testcases/const_statement/binding_generic/as_a_statement/destructuring/array/trailing_comma_is_insignificant.md
...
tokens (9x):
       ID_const PUNC_BRACKET_OPEN IDENT PUNC_COMMA PUNC_BRACKET_CLOSE
