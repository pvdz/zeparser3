...
- Path: tests/testcases/const_statement/binding_generic/as_a_statement/regular_vars/const_two_vars_with_both_init_semi.md
...
tokens (10x):
       IDENT IDENT PUNC_EQ IDENT PUNC_COMMA IDENT PUNC_EQ IDENT
       PUNC_SEMI
`````
