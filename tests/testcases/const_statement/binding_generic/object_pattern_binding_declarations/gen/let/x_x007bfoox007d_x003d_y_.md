...
- Path: tests/testcases/const_statement/binding_generic/object_pattern_binding_declarations/gen/let/x_x007bfoox007d_x003d_y_.md

> :: const statement : binding generic : object pattern binding declarations : gen : let
>
> ::> x x007bfoox007d x003d y
...
tokens (10x):
       ID_let IDENT PUNC_COMMA PUNC_CURLY_OPEN IDENT PUNC_CURLY_CLOSE
