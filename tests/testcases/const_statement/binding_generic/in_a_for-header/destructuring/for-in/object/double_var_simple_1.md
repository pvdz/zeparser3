...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-in/object/double_var_simple_1.md
...
tokens (13x):
       ...
       PUNC_COMMA IDENT PUNC_CURLY_CLOSE ID_in IDENT PUNC_PAREN_CLOSE
       PUNC_SEMI
`````
