...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-in/object/single_var_with_trailing_comma.md
...
tokens (12x):
       ...
       PUNC_COMMA PUNC_CURLY_CLOSE ID_in IDENT PUNC_PAREN_CLOSE
       PUNC_SEMI
`````
