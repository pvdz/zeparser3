...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-in/object/double_destruct_without_and_with_init.md
...
tokens (15x):
       ...
       PUNC_COMMA IDENT PUNC_EQ IDENT PUNC_CURLY_CLOSE ID_in IDENT
