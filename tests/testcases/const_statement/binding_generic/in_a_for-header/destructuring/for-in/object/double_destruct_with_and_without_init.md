...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-in/object/double_destruct_with_and_without_init.md
...
tokens (15x):
       ...
       PUNC_COMMA IDENT PUNC_CURLY_CLOSE IDENT IDENT PUNC_PAREN_CLOSE
       PUNC_SEMI
`````
