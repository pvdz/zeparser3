...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-in/object/single_destruct_with_rename_and_init.md
...
tokens (15x):
       ...
       PUNC_COLON IDENT PUNC_EQ IDENT PUNC_CURLY_CLOSE ID_in IDENT
