...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-in/array/trailing_comma_is_insignificant.md
...
tokens (12x):
       ...
       PUNC_COMMA PUNC_BRACKET_CLOSE ID_in IDENT PUNC_PAREN_CLOSE
       PUNC_SEMI
`````
