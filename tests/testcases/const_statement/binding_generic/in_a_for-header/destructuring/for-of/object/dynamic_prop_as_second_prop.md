...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/for-of/object/dynamic_prop_as_second_prop.md
...
tokens (17x):
       ...
       PUNC_COLON IDENT PUNC_CURLY_CLOSE ID_of IDENT PUNC_PAREN_CLOSE
       PUNC_SEMI
`````
