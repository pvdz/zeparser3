...
- Path: tests/testcases/const_statement/binding_generic/in_a_for-header/destructuring/regular_for-loop/object/single_destruct_with_rename_and_init.md
...
tokens (17x):
       ...
       PUNC_COLON IDENT PUNC_EQ IDENT PUNC_CURLY_CLOSE PUNC_EQ IDENT
