...
- Path: tests/testcases/unary_ops/generic_unary_tests_x0028GENERATEDx0029/batch_for_x0060x0021x0060/regex_edge_case/with_flag.md
...
tokens (10x):
       PUNC_EXCL IDENT PUNC_DOT IDENT PUNC_DIV IDENT PUNC_DIV IDENT
       ASI
`````
