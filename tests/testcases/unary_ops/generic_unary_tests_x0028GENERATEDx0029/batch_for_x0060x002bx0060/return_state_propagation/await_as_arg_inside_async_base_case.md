...
- Path: tests/testcases/unary_ops/generic_unary_tests_x0028GENERATEDx0029/batch_for_x0060x002bx0060/return_state_propagation/await_as_arg_inside_async_base_case.md
...
tokens (12x):
       ...
       PUNC_CURLY_OPEN PUNC_PLUS ID_await IDENT PUNC_SEMI
       PUNC_CURLY_CLOSE
`````
