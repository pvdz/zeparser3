...
- Path: tests/testcases/assigns/assigning_to_keyword/assigning_to_x005binterfacex005d.md

> :: assigns : assigning to keyword
>
> ::> assigning to x005binterfacex005d

## Input

`````js
(interface = "sentinal 543665")
`````
...
tokens (7x):
       PUNC_PAREN_OPEN ID_interface PUNC_EQ STRING_DOUBLE
