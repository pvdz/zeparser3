...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/should_listen_to_use_strict_directive_in_function_bare/foo.md
...
tokens (13x):
       ...
       PUNC_CURLY_OPEN STRING_DOUBLE PUNC_SEMI IDENT PUNC_EQ IDENT ASI
       PUNC_CURLY_CLOSE
`````
