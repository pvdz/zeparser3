...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/assigning_to_keyword_paren_wrapped/public.md
...
tokens (7x):
       PUNC_PAREN_OPEN ID_public PUNC_EQ IDENT PUNC_PAREN_CLOSE ASI
`````
