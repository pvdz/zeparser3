...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/assign_to_paren-wrapped_keyword_in_param_default/interface.md
...
tokens (15x):
       ...
       ID_interface PUNC_PAREN_CLOSE PUNC_EQ IDENT PUNC_PAREN_CLOSE
