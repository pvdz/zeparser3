...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/assign_to_paren-wrapped_keyword_in_param_default/implements.md
...
tokens (15x):
       ...
       ID_implements PUNC_PAREN_CLOSE PUNC_EQ IDENT PUNC_PAREN_CLOSE
