...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/should_listen_to_use_strict_directive_in_getter_wrapped/foo.md
              ...
              value: {
                ...
                body: {
                  ...
                  body: [
                    ...
                    {
                      type: 'ExpressionStatement',
                      loc:{start:{line:4,column:4},end:{line:4,column:14},source:''},
                      expression: {
                        type: 'AssignmentExpression',
                        loc:{start:{line:4,column:5},end:{line:4,column:12},source:''},
                        left: {
                          type: 'Identifier',
                          loc:{start:{line:4,column:5},end:{line:4,column:8},source:''},
                          name: 'foo'
                        },
                        operator: '=',
                        right: {
...
tokens (20x):
       IDENT PUNC_EQ PUNC_CURLY_OPEN IDENT IDENT PUNC_PAREN_OPEN
