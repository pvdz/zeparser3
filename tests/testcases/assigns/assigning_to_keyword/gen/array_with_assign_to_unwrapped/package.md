...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/array_with_assign_to_unwrapped/package.md
...
tokens (8x):
       ID_async IDENT PUNC_EQ_GT ID_package PUNC_EQ NUMBER_DEC ASI
`````
