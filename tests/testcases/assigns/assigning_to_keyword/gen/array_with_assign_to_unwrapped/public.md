...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/array_with_assign_to_unwrapped/public.md
...
tokens (8x):
       ID_async IDENT PUNC_EQ_GT ID_public PUNC_EQ NUMBER_DEC ASI
`````
