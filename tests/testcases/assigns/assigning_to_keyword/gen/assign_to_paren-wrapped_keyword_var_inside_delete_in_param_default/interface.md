...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/assign_to_paren-wrapped_keyword_var_inside_delete_in_param_default/interface.md
...
tokens (17x):
       ...
       PUNC_PAREN_OPEN ID_interface PUNC_PAREN_CLOSE PUNC_EQ IDENT
