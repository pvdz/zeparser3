...
- Path: tests/testcases/assigns/assigning_to_keyword/gen/assign_to_keyword_in_generator/package.md
...
tokens (12x):
       ...
       PUNC_CURLY_OPEN ID_package PUNC_EQ NUMBER_DEC PUNC_SEMI
       PUNC_CURLY_CLOSE
`````
