...
- Modified: -
- Path: zeparser3/tests/testcases/parser/async_keyword/class_method/async_object_method_with_newline_after_name.md
        ...
        body: [
          {
            ...
            loc:{start:{line:1,column:9},end:{line:2,column:6},source:''},
            key: {
              type: 'Identifier',
              loc:{start:{line:1,column:15},end:{line:2,column:1},source:''},
              name: 'foo'
            },
            static: false,
            computed: false,
