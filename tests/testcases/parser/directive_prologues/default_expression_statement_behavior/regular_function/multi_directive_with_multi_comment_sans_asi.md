...
- Modified: -
- Path: zeparser3/tests/testcases/parser/directive_prologues/default_expression_statement_behavior/regular_function/multi_directive_with_multi_comment_sans_asi.md
        ...
        body: [
          {
            ...
            loc:{start:{line:2,column:0},end:{line:3,column:5},source:''},
            expression: {
              type: 'Literal',
          ...
          },
          {
            ...
            expression: {
              type: 'Literal',
              loc:{start:{line:3,column:5},end:{line:3,column:5},source:''},
              value: 'bar',
              raw: '"bar"'
            },
            directive: 'bar'
