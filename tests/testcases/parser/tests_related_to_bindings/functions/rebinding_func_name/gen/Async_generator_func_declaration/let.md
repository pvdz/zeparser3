...
- Path: zeparser3/tests/testcases/parser/tests_related_to_bindings/functions/rebinding_func_name/gen/Async_generator_func_declaration
  ...
  body: [
    {
      ...
      loc:{start:{line:1,col:6},end:{line:1,col:32},source:''},
      generator: true,
      async: true,
      id: {
        type: 'Identifier',
      ...
      body: {
        type: 'BlockStatement',
        loc:{start:{line:1,col:19},end:{line:1,col:32},source:''},
        body: [
          {
