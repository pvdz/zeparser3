...
- Path: zeparser3/tests/testcases/parser/tests_related_to_bindings/block/annex_b_function_statement_exception/label_func_and_var_in_global.md
...
ast: {
  ...
  body: [
    ...
    },
    {
      ...
      loc:{start:{line:2,col:0},end:{line:2,col:20},source:''},
      label: {
        type: 'Identifier',
      ...
      body: {
        ...
        loc:{start:{line:2,col:6},end:{line:2,col:20},source:''},
        generator: false,
        async: false,
        id: {
          type: 'Identifier',
...
tokens (14x):
       IDENT IDENT PUNCTUATOR NUMBER_DEC PUNCTUATOR IDENT PUNCTUATOR
