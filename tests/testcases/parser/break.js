...
module.exports = (describe, test) =>
  describe('break statement', _ => {
    ...
    test('double break', {
      ...
      ast: {
        type: 'Program',
        body: [{type: 'BreakStatement', label: null}, {type: 'BreakStatement', label: null}],
      },
    ...
    test('double break with label and semi', {
      ...
      ast: {
        type: 'Program',
        body: [{type: 'BreakStatement', label: {type: 'Identifier', name: 'foo'}}, {type: 'BreakStatement', label: null}],
      },
