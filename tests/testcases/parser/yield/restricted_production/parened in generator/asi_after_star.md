...
- Path: zeparser3/tests/testcases/parser/yield/restricted_production/parened in generator/asi_after_star.md
        ...
        body: [
          {
            ...
            expression: {
              ...
              loc:{start:{line:3,column:2},end:{line:5,column:2},source:''},
              delegate: true,
              argument: {
                type: 'Identifier',
