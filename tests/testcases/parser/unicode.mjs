...
export default (describe, test) =>
  describe('unicode', _ => {
    ...
    describe('double byte chars', _ => {
      ...
      test.pass('identifier that is a higher unicode char 1', {
        code: SINGLE + '();',
      });
      test.pass('identifier starting with a higher unicode char 1', {
        code: SINGLE + 'foo();',
      });
      test.pass('identifier that contains a higher unicode char 1', {
        code: 'fo' + SINGLE + 'o();',
      });
      test.pass('identifier that ends with a higher unicode char 1', {
        code: 'foo' + SINGLE + '();',
      });
      test.pass('named group with unicode escape 1', {
        code: 'f(/(?<\\u0041>.)/);',
      });
      test.pass('named group with unicode escape 2', {
        code: 'f(/(?<\\u00AA>.)/);',
      });
    });
    describe('double byte chars', _ => {
      ...
      test.pass('identifier that is a higher unicode char 2', {
        code: DOUBLE + '();',
      });
      test.pass('identifier starting with a higher unicode char 2', {
        code: DOUBLE + 'foo();',
      });
      test.pass('identifier that contains a higher unicode char 2', {
        code: 'fo' + DOUBLE + 'o();',
      });
      test.pass('identifier that ends with a higher unicode char 2', {
        code: 'foo' + DOUBLE + '();',
      });
      test.pass('named group with unicode escape 3', {
        code: 'f(/(?<\\u03B2>.)/);',
      });
    });
