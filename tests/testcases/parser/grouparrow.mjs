  ...
  describe('parens', _ => {
    describe('group', _ => {
      ...
      describe('regular assignment to group', _ => {
        ...
        test('assignment to a wrapped property, silly but valid 1', {
          code: '(a.b) = 1;',
          ast: {
            type: 'Program',
            body: [
        ...
        test('assignment to a wrapped property, silly but valid 2', {
          code: '(a[b]) = 1;',
          ast: {
            type: 'Program',
            body: [
        ...
        test('assignment to a wrapped super property, silly but valid 1', {
        ...
        test('assignment to a wrapped super property, silly but valid 2', {
          code: 'class x{ constructor(){  (super[a]) = 1;  }}',
          ast: {
            type: 'Program',
            body: [
        ...
        test('assignment to a wrapped this property, silly but valid 1', {
          code: '(this.a) = 1;',
          ast: {
            type: 'Program',
            body: [
        ...
        test('assignment to a wrapped this property, silly but valid 2', {
          code: '(this[b]) = 1;',
          ast: {
            type: 'Program',
            body: [
        ...
        test.fail('assignment to grouped array is not okay 1', {
          code: '([x, y]) = z;',
          desc: 'while not a prod, the assignment to array/object is an explicit exception (search for `assignmentpattern`)',
        });
        ...
        test.fail('assignment to grouped array is not okay 2', {
          code: '({x, y}) = z;',
          desc: 'while not a prod, the assignment to array/object is an explicit exception (search for `assignmentpattern`)',
        });
      });
      ...
      test('async call with obj with tail 1', {
        code: 'async ({} + 1);',
        ast: {
          type: 'Program',
          body: [
      ...
      test('async call with obj with tail 2', {
        code: 'async ({} + 1) => x;',
        throws: true,
      });
      ...
      [undefined, 6, 7, 8, 9, Infinity].forEach(ES => {
        describe('trailing comma without arrow, ES=`' + ES + '`', _ => {
    ...
    describe('arrow', _ => {
      ...
      test('arrow inside template disambiguation test 1 1', {
        code: '`X${a => b}Y`',
        ast: {
          type: 'Program',
          body: [
      ...
      test('arrow inside template disambiguation test 1 2', {
        code: '`X${a => b + c}Y`',
        ast: {
          type: 'Program',
          body: [
      ...
      describe('spread', _ => {
        ...
        ['({a:b,...obj}) => {}', '({...obj} = {}) => {}', '({...(a,b),c})', '({...a,b,c})'].forEach((tcase, i) => {
          test.pass('good arrow destruct of obj case ' + i, {
            code: tcase,
          });
        });
      });
      ...
      describe('obj lit with array value that cant destruct', _ => {
        ...
        test.fail('arr with numbers 1', {
          code: '([0])=>0;',
        });
        test.fail('arr with numbers 2', {
          code: '([0])=>0;',
        });
