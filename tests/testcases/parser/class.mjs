...
export default (describe, test) => {
  describe('classes', _ => {
    ...
    describe('extending', _ => {
      ...
      test('extend expression also inherits the strict mode from class 1', {
      ...
      test('extend expression also inherits the strict mode from class 2', {
        code: 'class let {}',
    ...
    describe('dynamic methods', _ => {
      ...
      test.fail('generator setter member 1', {
        code: 'class A {* get [x](){}}',
        desc: 'setters dont syntactically support async/generator modifiers',
      ...
      test.fail('async getter member 1', {
      ...
      test.fail('generator setter member 2', {
        code: 'class A {* set [foo](x){}}',
        desc: 'setters dont syntactically support async/generator modifiers',
      ...
      test.fail('async getter member 2', {
        code: 'class A {async get [foo](){}}',
        desc: 'setters dont syntactically support async/generator modifiers',
        tokens: [$IDENT, $IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR],
      });
      test('generator with dynamic key 1', {
        code: 'class x { *[y](){}}',
        ast: {
          type: 'Program',
          body: [
      ...
      test('getter with dynamic key 1', {
        code: 'class x { get [y](){}}',
        ast: {
          type: 'Program',
          body: [
      ...
      test('setter with dynamic key 1', {
      ...
      test('generator with dynamic key 2', {
      ...
      test('getter with dynamic key 2', {
      ...
      test('setter with dynamic key 2', {
    ...
    test.pass('assert the paren 1', {
      code: 'class x {[x](){}}',
    });
    test.fail('assert the paren 2', {
      code: 'class x {[x]z){}}',
    });
