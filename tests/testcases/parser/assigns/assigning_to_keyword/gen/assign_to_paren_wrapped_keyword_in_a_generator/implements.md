...
- Path: tests/testcases/parser/assigns/assigning_to_keyword/gen/assign_to_paren_wrapped_keyword_in_a_generator
        ...
        body: [
          {
            ...
            expression: {
              ...
              loc:{start:{line:2,col:2},end:{line:2,col:18},source:''},
              left: {
                type: 'Identifier',
                loc:{start:{line:2,col:3},end:{line:2,col:13},source:''},
                name: 'implements'
              },
              operator: '=',
              right: {
