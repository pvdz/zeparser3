...
- Path: tests/testcases/parser/assigns/assigning_to_keyword/gen/should_listen_to_use_strict_directive_in_getter_wrapped
      ...
      expression: {
        ...
        right: {
          ...
          properties: [
            {
              type: 'Property',
              loc:{start:{line:2,column:2},end:{line:6,column:0},source:''},
              key: {
                type: 'Identifier',
              ...
              value: {
                ...
                body: {
                  type: 'BlockStatement',
                  loc:{start:{line:2,column:9},end:{line:6,column:0},source:''},
                  body: [
                    {
                      type: 'ExpressionStatement',
                      loc:{start:{line:3,column:4},end:{line:4,column:4},source:''},
                      expression: {
                        type: 'Literal',
                    ...
                    {
                      type: 'ExpressionStatement',
                      loc:{start:{line:4,column:4},end:{line:5,column:2},source:''},
                      expression: {
                        type: 'AssignmentExpression',
                        loc:{start:{line:4,column:5},end:{line:4,column:12},source:''},
                        left: {
                          type: 'Identifier',
                          loc:{start:{line:4,column:5},end:{line:4,column:9},source:''},
                          name: 'foo'
                        },
                        operator: '=',
                        right: {
