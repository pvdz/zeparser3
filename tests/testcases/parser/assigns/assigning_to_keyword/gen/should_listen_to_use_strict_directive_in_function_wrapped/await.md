...
- Path: tests/testcases/parser/assigns/assigning_to_keyword/gen/should_listen_to_use_strict_directive_in_function_wrapped
        ...
        body: [
          ...
          },
          {
            ...
            expression: {
              ...
              loc:{start:{line:3,col:3},end:{line:3,col:12},source:''},
              left: {
                type: 'Identifier',
                loc:{start:{line:3,col:3},end:{line:3,col:9},source:''},
                name: 'await'
              },
              operator: '=',
              right: {
                type: 'Identifier',
                loc:{start:{line:3,col:11},end:{line:3,col:12},source:''},
                name: 'x'
              }
            }
          }
