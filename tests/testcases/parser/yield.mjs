...
export default (describe, test) =>
  describe('yield', _ => {
    ...
    test('parse in all parts of ternary 1', {
    ...
    test.fail('parse in all parts of ternary 2', {
    ...
    test('spread yield yield comma 1', {
      code: 'function *g() {x={     ...yield yield,    };}',
      ast: {
        type: 'Program',
        body: [
    ...
    test('spread yield yield comma 2', {
      code: 'function *g() {yield {     ...yield yield,    };}',
      ast: {
        type: 'Program',
        body: [
    ...
    describe('yield in group in param default', _ => {
      ...
      test.fail_strict('group yield piggy test in arrow param default 1', {
        code: '(x=(yield)=y)=>z',
      });
      test.fail_strict('group yield piggy test in func param default 1', {
        code: 'function f(x=(yield)=y){}',
      });
      test.fail('group yield+arg piggy test in func param default 1', {
        code: 'function f(x=(yield z)=y){}',
      });
      test.fail('group yield piggy test in gen func param default 1', {
        code: 'function *f(x=(yield)=y){}',
      });
      test.fail('group yield+arg piggy test in gen func param default 1', {
        code: 'function *f(x=(yield z)=y){}',
      });
      test.fail('group yield piggy test in arrow param default 2', {
        code: 'function *f(){    (x=(yield)=y)=>z   }',
      });
      test.fail('group yield+arg piggy test in arrow param default', {
        code: 'function *f(){    (x=(yield z)=y)=>z   }',
      });
      test.fail_strict('group yield piggy test in func param default 2', {
        code: 'function *f(){    function g(x=(yield)=y){}   }',
        desc: 'a function does reset the yield/await state for params',
      });
      test.fail('group yield+arg piggy test in func param default 2', {
        code: 'function *f(){    function g(x=(yield z)=y){}   }',
      });
      test.fail('group yield piggy test in gen func param default 2', {
        code: 'function *f(){    function *g(x=(yield)=y){}   }',
      });
      test.fail('group yield+arg piggy test in gen func param default 2', {
        code: 'function *f(){    function *g(x=(yield z)=y){}   }',
      });
