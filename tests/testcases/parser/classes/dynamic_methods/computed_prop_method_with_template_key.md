...
- Path: zeparser3/tests/testcases/parser/classes/dynamic_methods/computed_prop_method_with_template_key.md

> :: classes : dynamic methods
>
> ::> computed prop method with template key
>
>Found by fuzzing
...
tokens (12x):
       IDENT IDENT PUNCTUATOR PUNCTUATOR TICK_PURE PUNCTUATOR
