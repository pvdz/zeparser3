...
- Modified: -
- Path: zeparser3/tests/testcases/parser/classes/piggies_in_classes/super_prop/wrapped_in_extending_class_in_constructor/in_wrapped_extends_no_args.md
            ...
            value: {
              ...
              body: {
                ...
                body: [
                  {
                    type: 'ClassDeclaration',
                    loc:{start:{line:1,column:40},end:{line:1,column:76},source:''},
                    id: {
                      type: 'Identifier',
                      ...
                      arguments: [
                        {
                          ...
                          property: {
                            type: 'Identifier',
                            loc:{start:{line:1,column:66},end:{line:1,column:66},source:''},
                            name: 'foo'
                          },
                          computed: false
                        }
