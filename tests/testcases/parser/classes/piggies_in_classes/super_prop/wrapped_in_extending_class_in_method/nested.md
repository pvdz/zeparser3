...
- Modified: -
- Path: zeparser3/tests/testcases/parser/classes/piggies_in_classes/super_prop/wrapped_in_extending_class_in_method/nested.md
            ...
            value: {
              ...
              body: {
                ...
                body: [
                  {
                    type: 'ClassDeclaration',
                    loc:{start:{line:1,column:32},end:{line:1,column:72},source:''},
                    id: {
                      type: 'Identifier',
                    ...
                    body: {
                      ...
                      body: [
                        {
                          type: 'MethodDefinition',
                          loc:{start:{line:1,column:42},end:{line:1,column:69},source:''},
                          key: {
                            type: 'Identifier',
                            ...
                            params: [
                              {
                                ...
                                right: {
                                  ...
                                  callee: {
                                    ...
                                    property: {
                                      type: 'Identifier',
                                      loc:{start:{line:1,column:59},end:{line:1,column:59},source:''},
                                      name: 'foo'
                                    },
                                    computed: false
                                  }
