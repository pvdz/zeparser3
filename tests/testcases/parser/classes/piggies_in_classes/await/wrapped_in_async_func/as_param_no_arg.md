...
- Modified: -
- Path: zeparser3/tests/testcases/parser/classes/piggies_in_classes/await/wrapped_in_async_func/as_param_no_arg.md
        ...
        body: [
          {
            ...
            body: {
              type: 'ClassBody',
              loc:{start:{line:1,column:31},end:{line:1,column:50},source:''},
              body: [
                {
