...
- Modified: -
- Path: zeparser3/tests/testcases/parser/classes/piggies_in_classes/super_ident/wrapped_in_plain_class_in_method/method_key.md
            ...
            value: {
              ...
              body: {
                ...
                body: [
                  {
                    type: 'ClassDeclaration',
                    loc:{start:{line:1,column:22},end:{line:1,column:45},source:''},
                    id: {
                      type: 'Identifier',
