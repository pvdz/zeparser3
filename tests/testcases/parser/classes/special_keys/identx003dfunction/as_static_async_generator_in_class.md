...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/classes/special_keys/identx003dfunction/as_static_async_generator_in_class.md

> :: classes : special keys : ident=function
>
        ...
        body: [
          {
            ...
            loc:{start:{line:1,col:9},end:{line:1,col:36},source:''},
            key: {
              type: 'Identifier',
              loc:{start:{line:1,col:24},end:{line:1,col:32},source:''},
              name: 'function'
            },
            static: true,
            computed: false,
