...
export default (describe, test) =>
  describe('for statement', _ => {
    describe('for-loop', _ => {
      ...
      test('for-classic, init and test and update, empty body 1', {
        code: 'for (a;b;c);',
        ast: {
          type: 'Program',
          body: [
      ...
      test('for-classic, init and test and update, empty body 2', {
      ...
      test('for-classic, init and test and update, empty body 3', {
        code: 'for (a * b + c * d;b;c);',
        ast: {
          type: 'Program',
          body: [
    ...
    describe('for-in', _ => {
      ...
      describe('web compat', _ => {
        ...
        test('var with init left and assignment right of `in`', {
          ...
          MODULE: {
            throws: 'Parser error! For-in and for-of binding can not have an init',
          },
        });
        ...
        test('destructuring with const is always illegal 1', {
          code: 'for (const x = 0 in {});',
          throws: true,
        });
        test('destructuring with const is always illegal 2', {
          code: 'for (let x = 0 in {});',
          throws: true,
        });
      });
      ...
      describe('lhs edge cases', _ => {
        ...
        test.fail_strict('yield no-arg lhs 1', {
          code: 'for (yield in x);',
        });
        test.fail('yield no-arg lhs 2', {
    ...
    describe('for-of', _ => {
      ...
      test('destructuring with property 1', {
      ...
      test.pass('destructuring with dynamic property 1', {
        code: 'for ([a.b][foo] of c) d',
      });
      test.fail('destructuring with call 1', {
        code: 'for ([a.b](foo) of c) d',
      });
      ...
      test('destructuring with property 2', {
      ...
      test.pass('destructuring with dynamic property 2', {
        code: 'for ({a: b.c}[x] of d) e',
      });
      test.fail('destructuring with call 2', {
        code: 'for ({a: b.c}() of d) e',
      });
      ...
      describe('lhs edge cases', _ => {
        ...
        test.fail('ternary in lhs 1', {
          code: 'for (a ? b : c of x);',
        });
        test.fail('ternary in lhs 2', {
          code: 'for (a ? b : c of x);',
        });
        test.fail('assignment in lhs', {
          code: 'for (a = b of x);',
    ...
    describe('for-await', _ => {
      ...
      test.fail('for await in non-async func 1', {
      ...
      test.fail('for await in non-async func 2', {
        code: 'function f() { for await (x of y) {} }',
      });
      test.fail('for await in non-async func 3', {
        code: 'function f() { for await (x of y) {} }',
      });
      test.fail('for await in non-async func 4', {
        code: 'function f() { for await (x of y) {} }',
      });
