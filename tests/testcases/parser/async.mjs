...
export default (describe, test) =>
  describe('async keyword', () => {
    ...
    test('async is callable as long as it isnt the statement expression itself 1', {
      code: 'foo(async)',
      ast: {
        type: 'Program',
        body: [
    ...
    test('async is callable as long as it isnt the statement expression itself 2', {
      code: 'foo(async.foo)',
      ast: {
        type: 'Program',
        body: [
    ...
    test('empty arrow with block body disambiguation inside template 1', {
      code: '`a ${async ()=>{}} b`',
      ast: {
        type: 'Program',
        body: [
    ...
    test('empty arrow with block body disambiguation inside template 2', {
      code: '`a ${async ()=>x} b`',
      ast: {
        type: 'Program',
        body: [
    ...
    describe('...', _ => {
      ...
      test.fail('dots with arrow must be rest which can not have init 1 1', {
        code: 'async (a, ...b+b=c) => a;',
      });
      test.fail('dots with arrow must be rest which can not have init 1 2', {
      ...
      test('call with spread second 1', {
        code: 'async(...a);',
        ast: {
          type: 'Program',
          body: [
      ...
      test('call with spread second 2', {
        code: 'async(a, ...b);',
        ast: {
          type: 'Program',
          body: [
    ...
    test.fail_strict('async call with nested await 1', {
      code: 'async(await);',
    });
    test.fail_strict('async call with nested await 2', {
      code: 'async(yield);',
    });
