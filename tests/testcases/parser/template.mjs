...
export default (describe, test) =>
  describe('templates', _ => {
    ...
    test('head${expr}tail template 1', {
      code: '`foo${bar}baz`',
      ast: {
        type: 'Program',
        body: [
    ...
    test('block wrapped 3-part template to check disambiguation 1', {
      code: '{`foo ${a} and ${b} and ${c} baz`}',
      ast: {
        type: 'Program',
        body: [
    ...
    test('head${expr}tail template 2', {
      code: '`foo${`foo`}baz`',
      ast: {
        type: 'Program',
        body: [
    ...
    test('block wrapped 3-part template to check disambiguation 2', {
