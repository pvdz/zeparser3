...
import {
  ...
  $TICK_TAIL,
  $WHITE,
} from '../../../src/zetokenizer.mjs'; // Tests in this file should concern themselves with parser ambiguity, not lexer test cases. Those can
...
export default (describe, test) =>
  describe('regexes', _ => {
    ...
    test.pass('shorter lodash case 1', {
      code: 'x = /[^\\x00-\\x2f]+/g;',
    });
    test.pass('shorter lodash case 2', {
      code: 'x = /[^\\x00-\\x2f]+/g;',
    });
