...
- Modified: -
- Path: zeparser3/tests/testcases/parser/whitespace/html_comments/html_close_comment_can_have_multiline_comment_on_a_multiple_lines_before_it.md
...
ast: {
  type: 'Program',
  loc:{start:{line:1,col:0},end:{line:3,col:18},source:''},
  body: []
}
