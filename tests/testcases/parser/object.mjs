  ...
  describe('objects', _ => {
    describe('literals', _ => {
      ...
      describe('number properties', _ => {
        test('object with one number property 1', {
          code: 'wrap({15:b});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with one number property 2', {
      ...
      describe('string properties', _ => {
        test('object with one double quoted property 1', {
          code: 'wrap({"a":b});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with two double quoted properties 1', {
          code: 'wrap({"a":b, "c":d});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with one double quoted property 2', {
          code: "wrap({'a':b});",
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with two double quoted properties 2', {
          code: "wrap({'a':b, 'c':d});",
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with two double quoted properties 3', {
          code: "wrap({'a':b, c:d});",
          ast: {
            type: 'Program',
            body: [
      ...
      describe('computed properties', _ => {
        test('object literal, one computed property 1', {
          code: 'wrap({[a]:b});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object literal, one computed property 2', {
          code: 'wrap({[a]:b, [15]:d});',
          ast: {
            type: 'Program',
            body: [
      ...
      describe('async method', _ => {
        test('object with one async method 1', {
          code: 'wrap({async foo(){}});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with one async method 2', {
          code: 'wrap({async [foo](){}});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with an async method and an ident method 1', {
        ...
        test('object with an async method and an ident method 2', {
      ...
      describe('getters (ident)', _ => {
        ...
        test('object with an getter method and an ident method 1', {
        ...
        test('object with an getter method and an ident method 2', {
      ...
      describe('getters (rest)', _ => {
        test('object with one getter method 1', {
          code: "wrap({get 'foo'(){}});",
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with one getter method 2', {
          code: 'wrap({get "foo"(){}});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with one getter method 3', {
          code: 'wrap({get 123(){}});',
          ast: {
            type: 'Program',
            body: [
      ...
      describe('setters (ident)', _ => {
        test('object with one setter method 1', {
          code: 'wrap({set foo(a){}});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with one setter method 2', {
          code: 'wrap({set get(a){}});',
          ast: {
            type: 'Program',
            body: [
        ...
        test('object with an setter method and an ident method 1', {
        ...
        test('object with an setter method and an ident method 2', {
      ...
      describe('setters (rest)', _ => {
        ...
        test('object with one setter method 3', {
          code: 'wrap({set 123(a){}});',
          ast: {
            type: 'Program',
            body: [
      ...
      test.fail('can not use async/generators on getters/setters 1', {
        code: '({async get foo(){}});',
      });
      test.fail('can not use async/generators on getters/setters 2', {
        code: '({get set foo(){}});',
      });
      test.fail('can not use async/generators on getters/setters 3', {
        code: '({async set foo(){}});',
      });
    ...
    ['true', 'false', 'null', 'this'].forEach(keyword => {
      describe('non-ident key with keyword value for keyword=`' + keyword + '`', _ => {
    ...
    ['super()', 'super.cool', 'super[cool]'].forEach(keyword => {
      describe('good supers, keyword=`' + keyword + '`', _ => {
    ...
    describe('bad supers', _ => {
      ['super'].forEach(keyword => {
        describe('string key, keyowrd=`' + keyword + '`', _ => {
          test.fail('object', {
            code: `class x extends y {constructor(){    ({"foo": ${keyword}})    }}`,
          });
          test.fail('destructuring', {
    ...
    describe('ellipsis', _ => {
      ...
      test.pass('base case 2', {
        code: 'x = {...y}',
        ES: 9,
        desc: 'first version where this was introduced',
      });
      test.fail('base case 3', {
        code: 'x = {...y}',
        ES: 8,
      });
      test.fail('base case 4', {
        code: 'x = {...y}',
        ES: 7,
      });
      test.fail('base case 5', {
        code: 'x = {...y}',
        ES: 6,
      });
          ...
          describe('without webcompat', _ => {
            ...
            describe('exceptions', _ => {
              ...
              describe('not async', _ => {
                ...
                test.pass('inside a complex destruct in an arrow 1', {
                ...
                test.pass('inside a complex destruct in an arrow 2', {
