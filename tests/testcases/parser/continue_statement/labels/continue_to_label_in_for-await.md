  ...
  body: [
    {
      ...
      loc:{start:{line:1,column:6},end:{line:1,column:59},source:''},
      generator: false,
      async: true,
      id: {
        type: 'Identifier',
        ...
        body: [
          {
            ...
            body: {
              ...
              body: {
                ...
                loc:{start:{line:1,column:44},end:{line:1,column:58},source:''},
                label: {
                  type: 'Identifier',
                  loc:{start:{line:1,column:53},end:{line:1,column:53},source:''},
                  name: 'foo'
                }
              }
            }
