...
- Modified: -
- Path: zeparser3/tests/testcases/parser/super_keyword/superx0028x0029/class_constructors/no_syntax_error_to_refer_to_x0060superx0060_prop_before_calling_x0060superx0028x0029x0060.md

> :: super keyword : super() : class constructors
>
> ::> no syntax error to refer to `super` prop before calling `super()`
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:34},end:{line:1,column:63},source:''},
                body: [
                  {
