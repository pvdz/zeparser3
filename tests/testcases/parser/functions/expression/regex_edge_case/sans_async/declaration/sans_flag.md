...
- Modified: -
- Path: zeparser3/tests/testcases/parser/functions/expression/regex_edge_case/sans_async/declaration/sans_flag.md
  ...
  body: [
    {
      ...
      body: {
        type: 'BlockStatement',
        loc:{start:{line:1,column:12},end:{line:2,column:0},source:''},
        body: []
      }
    },
    {
