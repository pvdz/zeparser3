...
- Modified: -
- Path: zeparser3/tests/testcases/parser/functions/expression/regex_edge_case/with_async/expression/with_flag.md
        ...
        left: {
          ...
          left: {
            ...
            argument: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,column:25},end:{line:2,column:0},source:''},
                body: []
              }
            }
          },
...
tokens (14x):
       ...
       PUNCTUATOR PUNCTUATOR IDENT PUNCTUATOR IDENT ASI
`````
