...
export default (describe, test) =>
  describe('debugger statement', _ => {
    ...
    describe('await', _ => {
      test.pass('in sloppy 1', {
        code: 'await: x',
        MODULE: {
          throws: true,
        },
      });
      test.fail_strict('in a generator 1', {
        code: 'function *f(){ await: x; }',
      });
      test.fail('defined outside of generator as break label inside generator 1', {
    ...
    describe('await', _ => {
      test.fail_strict('in sloppy 2', {
        code: 'yield: x',
      });
      test.fail('in a generator 2', {
        code: 'function *f(){ yield: x; }',
      });
      test.fail('defined outside of generator as break label inside generator 2', {
