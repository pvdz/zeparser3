...
export default (describe, test) =>
  describe('var statement', _ => {
      ...
      describe('reserved words', _ => {
        [
          ...
          describe(`always keyword=${name}`, _ => {
            ...
            test(`for header`, {code: `for (var ${name} = x;;);`, throws: 'reserved word'});
            test(`function arg`, {code: `function f(${name}) {}`, throws: true});
            test(`function object destructured arg`, {code: `function f({${name}}) {}`, throws: true});
            test(`function object alias destructured arg`, {code: `function fh({x: ${name}}) {}`, desc: 'certain tokens fail because they are part of a multi-token expression', throws: true});
            test(`function array destructured arg`, {code: `function f([${name}]) {}`, throws: true});
            test(`catch clause`, {code: `try {} catch (${name}) {}`, throws: 'reserved word'});
            test(`export`, {code: `export var ${name} = 10;`, SCRIPT: {desc: 'export is only allowed in module code', throws: true}, throws: 'reserved word'});
            test(`can be property`, {
              code: `obj.${name}`,
              ast: {type: 'Program', body: [{type: 'ExpressionStatement', expression: {type: 'MemberExpression', object: {type: 'Identifier', name: 'obj'}, property: {type: 'Identifier', name: name}, computed: false}}]},
        ...
        [
          ...
          describe(`strict mode keyword3=${name}`, _ => {
            ...
            test(`function arg`, {code: `function f(${name}) {}`, throws: 'reserved word', SLOPPY_SCRIPT: {ast: true, tokens: true}});
            test(`function object destructured arg`, {code: `function f({${name}}) {}`, throws: true, SLOPPY_SCRIPT: {ast: true, tokens: true}});
            test(`function object alias destructured arg`, {code: `function fg({x: ${name}}) {}`, throws: true, SLOPPY_SCRIPT: {ast: true, tokens: true}});
            test(`function array destructured arg`, {code: `function f([${name}]) {}`, throws: true, SLOPPY_SCRIPT: {ast: true, tokens: true}});
            test(`catch clause`, {code: `try {} catch (${name}) {}`, throws: true, SLOPPY_SCRIPT: {ast: true, tokens: true}});
            test(`export`, {code: `export var ${name} = 10;`, SLOPPY: {desc: 'export is only allowed in module code', throws: 'export'}, throws: true});
      ...
      describe('as a statement', _ => {
        describe('regular vars', _ => {
          test('var, one var, no init, semi', {
            code: 'var foo;',
            ast: {type: 'Program', body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: null}]}]},
          ...
          test('var, two vars, no init, semi', {
            ...
            ast: {
              type: 'Program',
              body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: null}, {type: 'VariableDeclarator', id: {type: 'Identifier', name: 'bar'}, init: null}]}],
            },
          ...
          test('var, var with init, semi', {
            code: 'var foo = bar;',
            ast: {type: 'Program', body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: {type: 'Identifier', name: 'bar'}}]}]},
            tokens: [$IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR],
          });
          ...
          test('var, var with init, asi', {
            ...
            ast: {
              type: 'Program',
              body: [
                {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: {type: 'Identifier', name: 'bar'}}]},
                {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'zoo'}, init: null}]},
              ],
            },
          ...
          test('asi can not trigger if next token is ident', {code: 'var\nfoo()', throws: 'ASI', tokens: [$IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $ASI]});
        });
        describe('destructuring', _ => {
          describe('array', _ => {
            test('empty "array" should work', {
              code: 'var [] = x;',
              ast: {type: 'Program', body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: []}, init: {type: 'Identifier', name: 'x'}}]}]},
              tokens: [$IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR],
            });
            test('empty array with one comma', {
              code: 'var [,] = x;',
              ast: {type: 'Program', body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null]}, init: {type: 'Identifier', name: 'x'}}]}]},
              tokens: [$IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR],
            });
            test('empty array with double comma', {
              code: 'var [,,] = x;',
              ast: {type: 'Program', body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, null]}, init: {type: 'Identifier', name: 'x'}}]}]},
            ...
            test('with one var, no init, semi', {
              ...
              ast: {
                type: 'Program',
                body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]}],
              },
            ...
            test('double trailing comma is significant', {
              ...
              ast: {
                type: 'Program',
                body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}, null]}, init: {type: 'Identifier', name: 'arr'}}]}],
              },
            ...
            test('leading comma', {
              ...
              ast: {
                type: 'Program',
                body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, {type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]}],
              },
            ...
            test('double leading comma', {
              ...
              ast: {
                type: 'Program',
                body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, null, {type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]}],
              },
            ...
            test('no assignment with two declarations second', {code: 'var foo, [bar];', throws: 'destructuring must have init', tokens: [$IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('cannot rename a var like obj destruct can', {code: 'var [foo:bar] = obj;', throws: true});
            describe('rest operator', _ => {
              ...
              test('rest followed by an ident', {code: 'var [...foo, bar] = obj;', throws: true});
              test('rest followed by a trailing comma', {code: 'var [...foo,] = obj;', desc: 'while feasible the syntax spec currently does not have a rule for allowing trailing commas after rest', throws: true});
              test('rest followed by two commas', {code: 'var [...foo,,] = obj;', throws: true});
              ...
              test('trailing comma after rest on a nested destruct', {code: 'var [...[foo, bar],] = obj;', throws: true});
              test('double trailing comma after rest on a nested destruct', {code: 'var [...[foo, bar],,] = obj;', throws: true});
              ...
              test('rest with default', {code: 'var [...bar = foo] = obj;', desc: 'rest cannot get a default in var decls but they can as func args', throws: true});
              test('double rest / spread rest', {code: 'var [... ...foo] = obj;', throws: 'Can not rest twice', tokens: []});
              test('rest without value', {code: 'var [...] = obj;', throws: true});
              test('rest with comma without value', {code: 'var [...,] = obj;', throws: true});
              test('single dot vs rest', {code: 'var [.x] = obj;', throws: true});
              test('double dot vs rest', {code: 'var [..x] = obj;', throws: true});
              test('spread vs rest', {
                code: 'var [a=[...b], ...c] = obj;',
                ast: {
                  type: 'Program',
          ...
          describe('object', _ => {
            test('empty obj', {
              code: 'var {} = obj;',
              ast: {type: 'Program', body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ObjectPattern', properties: []}, init: {type: 'Identifier', name: 'obj'}}]}]},
              tokens: [$IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR],
            });
            test('empty obj with trailing comma', {code: 'var {,} = obj;', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
            test('empty obj with elided commas', {code: 'var {,,} = obj;', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
            ...
            test('single destruct no assignment', {code: 'var {x};', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('double destruct no assignment', {code: 'var {x}, {y} = z;', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('ident and destruct no assignment', {code: 'var x, {y};', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('destruct no assignment and ident', {code: 'var {x}, y;', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('ident with init and destruct no assignment', {code: 'var x = y, {z};', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('single destruct with rename and no assignment', {code: 'var {x:y};', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('single destruct with default and no assignment', {code: 'var {x=y};', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            test('single destruct with rename and default and no assignment', {code: 'var {x:y=z};', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
            ...
            test('single destruct with colon-eq', {code: 'var {a:=c} = z;', throws: true});
            ...
            test('dynamic property destructuring missing alias', {code: 'var {[x]} = z;', throws: 'computed property name', tokens: []});
            test('dynamic property destructuring missing alias and init', {code: 'var {[x]};', throws: 'computed property name', tokens: []});
            test('dynamic property destructuring missing assignment', {code: 'var {[x]: y};', throws: 'destructuring must have init', tokens: []});
            test('dynamic property destructuring with default missing alias', {code: 'var {[x] = y} = z;', throws: 'computed property name', tokens: []});
            test('dynamic property destructuring with default and alias missing init', {code: 'var {[x]: y = z};', throws: 'destructuring must have init', tokens: []});
          ...
          describe('regular for-loop', _ => {
            test('var, one var, no init, semi', {
              ...
              ast: {
                type: 'Program',
                body: [
                  {type: 'ForStatement', init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: null}]}, test: null, update: null, body: {type: 'EmptyStatement'}},
                ],
              },
            ...
            test('var, two vars, no init, semi', {
              ...
              ast: {
                ...
                body: [
                  {
                    type: 'ForStatement',
                    init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: null}, {type: 'VariableDeclarator', id: {type: 'Identifier', name: 'bar'}, init: null}]},
                    test: null,
                    update: null,
            ...
            test('var, var with init, semi', {
              ...
              ast: {
                ...
                body: [
                  {
                    type: 'ForStatement',
                    init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: {type: 'Identifier', name: 'bar'}}]},
                    test: null,
                    update: null,
                    body: {type: 'EmptyStatement'},
                  },
            ...
            test('asi can not trigger if next token is ident', {code: 'for (var\nfoo();;);', throws: '(`;`)', desc: 'expecting for-header semi', tokens: [$IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $ASI]});
          });
          describe('invalid colorless for statement', _ => {
            test('var, one var, no init, semi', {code: 'for (var foo);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('var, two vars, no init, semi', {code: 'for (var foo, bar);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('var, var with init, semi', {code: 'for (var foo = bar);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('var, two vars with both init, semi', {
              code: 'for (var foo = bar, zoo = boo);',
              throws: '(`;`)',
              tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR],
            });
            test('var on next line does not trigger asi', {code: 'for (var\nfoo);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('asi can not trigger if next token is ident', {code: 'for (var\nfoo());', throws: '(`;`)', desc: 'expecting for-header semi', tokens: [$IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $ASI]});
          });
          describe('for-in', _ => {
            test('var, one var, no init, semi', {
              ...
              ast: {
                ...
                body: [
                  {
                    type: 'ForInStatement',
                    left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: null}]},
            ...
            test('var, two vars, no init, semi', {code: 'for (var foo, bar in x);', throws: 'can only have one binding', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('var, var with init, semi', {
            ...
            test('asi can not trigger if next token is ident', {code: 'for (var\nfoo() in x);', throws: '(`;`)', desc: 'expecting for-header semi', tokens: [$IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $ASI]});
          });
          describe('for-of', _ => {
            test('var, one var, no init, semi', {
            ...
            test('var, two vars, no init, semi', {code: 'for (var foo, bar of x);', throws: 'can only have one binding', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('var, var with init, semi', {code: 'for (var foo = bar of x);', throws: 'binding can not have an init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
            test('var, two vars with both init, semi', {
            ...
            test('asi can not trigger if next token is ident', {code: 'for (var\nfoo() of x);', throws: '(`;`)', desc: 'expecting for-header semi', tokens: [$IDENT, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $ASI]});
          });
        });
        describe('destructuring', _ => {
          ...
          describe('regular for-loop', _ => {
            describe('array', _ => {
              test('empty "array" should work', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: []}, init: {type: 'Identifier', name: 'x'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('empty array with one comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null]}, init: {type: 'Identifier', name: 'x'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('empty array with double comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, null]}, init: {type: 'Identifier', name: 'x'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('with one var, no init, semi', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('double trailing comma is significant', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}, null]}, init: {type: 'Identifier', name: 'arr'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('leading comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, {type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('double leading comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, null, {type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              describe('rest operator', _ => {
                ...
                test('rest followed by an ident', {code: 'for (var [...foo, bar] = obj;;);', throws: true});
                test('rest followed by a trailing comma', {code: 'for (var [...foo,] = obj;;);', throws: true});
                test('rest followed by two commas', {code: 'for (var [...foo,,] = obj;;);', throws: true});
                test('rest on a nested destruct', {
                  code: 'for (var [...[foo, bar]] = obj;;);',
                  ast: {
                    type: 'Program',
                ...
                test('trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],] = obj;;);', throws: true});
                test('double trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],,] = obj;;);', throws: true});
                test('second param rest on a nested destruct', {
                ...
                test('rest with default', {code: 'for (var [...bar = foo] = obj;;);', desc: 'rest cannot get a default in var decls but they can as func args', throws: true});
                test('double rest / spread rest', {code: 'for (var [... ...foo] = obj;;);', throws: 'Can not rest twice', tokens: []});
                test('rest without value', {code: 'for (var [...] = obj;;);', throws: true});
                test('rest with comma without value', {code: 'for (var [...,] = obj;;);', throws: true});
                test('single dot vs rest', {code: 'for (var [.x] = obj;;);', throws: true});
                test('double dot vs rest', {code: 'for (var [..x] = obj;;);', throws: true});
            ...
            describe('object', _ => {
              test('empty obj', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForStatement',
                      init: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ObjectPattern', properties: []}, init: {type: 'Identifier', name: 'obj'}}]},
                      test: null,
                      update: null,
                      body: {type: 'EmptyStatement'},
                    },
              ...
              test('empty obj with trailing comma', {code: 'for (var {,} = obj;;);', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
              test('empty obj with elided commas', {code: 'for (var {,,} = obj;;);', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
              test('single var base case', {
                code: 'for (var {x} = obj;;);',
                ast: {
                  type: 'Program',
              ...
              test('single destruct no assignment', {code: 'for (var {x};;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('double destruct no assignment', {code: 'for (var {x}, {y} = z;;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident and destruct no assignment', {code: 'for (var x, {y};;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident', {code: 'for (var {x}, y;;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident with init and destruct no assignment', {code: 'for (var x = y, {z};;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('single destruct with rename and no assignment', {code: 'for (var {x:y};;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('single destruct with default and no assignment', {code: 'for (var {x=y};;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('single destruct with rename and default and no assignment', {code: 'for (var {x:y=z};;);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('double destruct with rename and default and with and without assignment', {
              ...
              test('single destruct with colon-eq', {code: 'for (var {a:=c} = z;;);', throws: true});
              test('correct dynamic property destructuring', {
                code: 'for (var {[x]: y} = z;;);',
                ast: {
                  type: 'Program',
              ...
              test('dynamic property destructuring missing alias', {code: 'for (var {[x]} = z;;);', throws: 'computed property name', tokens: []});
              test('dynamic property destructuring missing alias and init', {code: 'for (var {[x]};;);', throws: 'computed property name', tokens: []});
              test('dynamic property destructuring missing assignment', {code: 'for (var {[x]: y};;);', throws: 'destructuring must have init', tokens: []});
              test('dynamic property destructuring with default missing alias', {code: 'for (var {[x] = y} = z;;);', throws: 'computed property name', tokens: []});
              test('dynamic property destructuring with default and alias missing init', {code: 'for (var {[x]: y = z};;);', throws: 'destructuring must have init', tokens: []});
              test('correct dynamic property destructuring with default and alias', {
          ...
          describe('invalid colorless for-statement', _ => {
            ...
            describe('array', _ => {
              test('empty "array" should work', {code: 'for (var [] = x);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
              test('empty array with one comma', {code: 'for (var [,] = x);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
              test('empty array with double comma', {
                code: 'for (var [,,] = x);',
                throws: '(`;`)',
                tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR],
              });
              test('with one var, no init, semi', {code: 'for (var [foo] = arr);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
              test('trailing comma is insignificant', {
                code: 'for (var [foo,] = arr);',
                throws: '(`;`)',
                tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR],
              ...
              test('leading comma', {code: 'for (var [,foo] = arr);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
              test('double leading comma', {
                code: 'for (var [,,foo] = arr);',
                throws: '(`;`)',
                tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR],
              ...
              describe('rest operator', _ => {
                test('rest as the only destruct', {code: 'for (var [...foo] = obj);', throws: true});
                test('rest preceded by an ident', {code: 'for (var [foo, ...bar] = obj);', throws: true});
                test('rest followed by an ident', {code: 'for (var [...foo, bar] = obj);', throws: true});
                test('rest followed by a trailing comma', {code: 'for (var [...foo,] = obj);', throws: true});
                test('rest followed by two commas', {code: 'for (var [...foo,,] = obj);', throws: true});
                test('rest on a nested destruct', {code: 'for (var [...[foo, bar]] = obj);', throws: true});
                test('trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],] = obj);', throws: true});
                test('double trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],,] = obj);', throws: true});
                test('second param rest on a nested destruct', {code: 'for (var [x, ...[foo, bar]] = obj);', throws: true});
                test('rest with default', {code: 'for (var [...bar = foo] = obj);', desc: 'rest cannot get a default in var decls but they can as func args', throws: true});
                test('double rest / spread rest', {code: 'for (var [... ...foo] = obj);', throws: 'Can not rest twice', tokens: []});
                test('rest without value', {code: 'for (var [...] = obj);', throws: true});
                test('rest with comma without value', {code: 'for (var [...,] = obj);', throws: true});
                test('single dot vs rest', {code: 'for (var [.x] = obj);', throws: true});
                test('double dot vs rest', {code: 'for (var [..x] = obj);', throws: true});
                test('spread and rest', {code: 'for (var [a=[...b], ...c] = obj);', throws: true});
              });
            });
            describe('object', _ => {
              test('empty obj', {code: 'for (var {} = obj);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
              test('empty obj with trailing comma', {code: 'for (var {,} = obj);', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
              test('empty obj with elided commas', {code: 'for (var {,,} = obj);', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
              test('single var base case', {code: 'for (var {x} = obj);', throws: '(`;`)', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR]});
              test('single var with trailing comma', {
                code: 'for (var {x,} = obj);',
                throws: '(`;`)',
                tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR, $PUNCTUATOR],
              ...
              test('double destruct no assignment', {code: 'for (var {x}, {y} = z);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident and destruct no assignment', {code: 'for (var x, {y});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident 1', {code: 'for (var {x}, y);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident with init and destruct no assignment', {code: 'for (var x = y, {z});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident 2', {code: 'for (var {x}, y);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('single destruct with rename and no assignment', {code: 'for (var {x:y});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('single destruct with default and no assignment', {code: 'for (var {x=y});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('single destruct with rename and default and no assignment', {code: 'for (var {x:y=z});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('double destruct with rename and default and with and without assignment', {
          ...
          describe('for-in', _ => {
            describe('array', _ => {
              test('empty "array" should work', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: []}, init: null}]},
                      right: {type: 'Identifier', name: 'x'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('empty array with one comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null]}, init: null}]},
                      right: {type: 'Identifier', name: 'x'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('empty array with double comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, null]}, init: null}]},
                      right: {type: 'Identifier', name: 'x'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('with one var, no init, semi', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}]}, init: null}]},
              ...
              test('double trailing comma is significant', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}, null]}, init: null}]},
                      right: {type: 'Identifier', name: 'arr'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('leading comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, {type: 'Identifier', name: 'foo'}]}, init: null}]},
                      right: {type: 'Identifier', name: 'arr'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('double leading comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [null, null, {type: 'Identifier', name: 'foo'}]}, init: null}]},
                      right: {type: 'Identifier', name: 'arr'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('two vars', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}, {type: 'Identifier', name: 'bar'}]}, init: null}]},
                      right: {type: 'Identifier', name: 'arr'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('two vars with eliding comma', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}, null, {type: 'Identifier', name: 'bar'}]}, init: null}]},
                      right: {type: 'Identifier', name: 'arr'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              describe('rest operator', _ => {
                test('rest as the only destruct', {
                  ...
                  ast: {
                    ...
                    body: [
                      {
                        type: 'ForInStatement',
                        left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'RestElement', argument: {type: 'Identifier', name: 'foo'}}]}, init: null}]},
                ...
                test('rest followed by an ident', {code: 'for (var [...foo, bar] in obj);', throws: true});
                test('rest followed by a trailing comma', {code: 'for (var [...foo,] in obj);', throws: true});
                test('rest followed by two commas', {code: 'for (var [...foo,,] in obj);', throws: true});
                test('rest on a nested destruct', {
                  code: 'for (var [...[foo, bar]] in obj);',
                  ast: {
                    type: 'Program',
                ...
                test('trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],] in obj);', throws: true});
                test('double trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],,] in obj);', throws: true});
                test('second param rest on a nested destruct', {
                ...
                test('rest with default', {code: 'for (var [...bar = foo] in obj);', desc: 'rest cannot get a default in var decls but they can as func args', throws: true});
                test('double rest / spread rest', {code: 'for (var [... ...foo] in obj);', throws: 'Can not rest twice', tokens: []});
                test('rest without value', {code: 'for (var [...] in obj);', throws: true});
                test('rest with comma without value', {code: 'for (var [...,] in obj);', throws: true});
                test('single dot vs rest', {code: 'for (var [.x] in obj);', throws: true});
                test('double dot vs rest', {code: 'for (var [..x] in obj);', throws: true});
                test('spread and rest', {
            ...
            describe('object', _ => {
              test('empty obj', {
                ...
                ast: {
                  ...
                  body: [
                    {
                      type: 'ForInStatement',
                      left: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ObjectPattern', properties: []}, init: null}]},
                      right: {type: 'Identifier', name: 'obj'},
                      body: {type: 'EmptyStatement'},
                    },
                  ],
              ...
              test('empty obj with trailing comma', {code: 'for (var {,} in obj);', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
              test('empty obj with elided commas', {code: 'for (var {,,} in obj);', throws: 'Objects cant have comma without something preceding it', desc: 'works for array but not for obj', tokens: []});
              test('single var base case', {
              ...
              test('single destruct no assignment', {code: 'for (var {x});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('double destruct no assignment', {code: 'for (var {x}, {y} in z);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident and destruct no assignment', {code: 'for (var x, {y});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident 1', {code: 'for (var {x}, y);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident with init and destruct no assignment', {code: 'for (var x = y, {z});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident 2', {code: 'for (var {x}, y);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              ...
              test('single destruct with colon-eq', {code: 'for (var {a:=c} in z);', throws: true});
              test('correct dynamic property destructuring', {
                code: 'for (var {[x]: y} in obj);',
                ast: {
                  type: 'Program',
              ...
              test('dynamic property destructuring missing alias', {code: 'for (var {[x]} in obj);', throws: 'computed property name', tokens: []});
              test('dynamic property destructuring with default missing alias', {code: 'for (var {[x] = y} in obj);', throws: 'computed property name', tokens: []});
              test('correct dynamic property destructuring with default and alias', {
                code: 'for (var {[x]: y = z} in obj);',
                ast: {
                  type: 'Program',
          ...
          describe('for-of', _ => {
            describe('array', _ => {
              ...
              describe('rest operator', _ => {
                ...
                test('rest followed by an ident', {code: 'for (var [...foo, bar] of obj);', throws: true});
                test('rest followed by a trailing comma', {code: 'for (var [...foo,] of obj);', throws: true});
                test('rest followed by two commas', {code: 'for (var [...foo,,] of obj);', throws: true});
                test('rest on a nested destruct', {
                  code: 'for (var [...[foo, bar]] of obj);',
                  ast: {
                    type: 'Program',
                ...
                test('trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],] of obj);', throws: true});
                test('double trailing comma after rest on a nested destruct', {code: 'for (var [...[foo, bar],,] of obj);', throws: true});
                test('second param rest on a nested destruct', {
                ...
                test('rest with default', {code: 'for (var [...bar = foo] of obj);', desc: 'rest cannot get a default of var decls but they can as func args', throws: true});
                test('double rest / spread rest', {code: 'for (var [... ...foo] of obj);', throws: 'Can not rest twice'});
                test('rest without value', {code: 'for (var [...] of obj);', throws: true});
                test('rest with comma without value', {code: 'for (var [...,] of obj);', throws: true});
                test('single dot vs rest', {code: 'for (var [.x] of obj);', throws: true});
                test('double dot vs rest', {code: 'for (var [..x] of obj);', throws: true});
                test('spread and rest', {
            ...
            describe('object', _ => {
              ...
              test('empty obj with trailing comma', {code: 'for (var {,} of obj);', desc: 'works for array but not for obj', throws: true});
              test('empty obj with elided commas', {code: 'for (var {,,} of obj);', desc: 'works for array but not for obj', throws: true});
              test('single var base case', {
              ...
              test('single var with double trailing comma', {code: 'for (var {x,,} of obj);', throws: 'Objects cant have comma without something preceding it', desc: 'does not work with obj, only array'});
              test('single var with leading comma', {code: 'for (var {,x} of obj);', throws: 'Objects cant have comma without something preceding it', desc: 'works with array but not with obj'});
              test('single var with double leading comma', {
                code: 'for (var {,,x} of obj);',
                throws: 'Objects cant have comma without something preceding it',
                desc: 'works with array but not with obj',
              ...
              test('single destruct no assignment', {code: 'for (var {x});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('double destruct no assignment', {code: 'for (var {x}, {y} of z);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident and destruct no assignment', {code: 'for (var x, {y});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident 1', {code: 'for (var {x}, y);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('ident with init and destruct no assignment', {code: 'for (var x = y, {z});', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              test('destruct no assignment and ident 2', {code: 'for (var {x}, y);', throws: 'destructuring must have init', tokens: [$IDENT, $PUNCTUATOR, $IDENT, $PUNCTUATOR, $PUNCTUATOR, $IDENT, $PUNCTUATOR]});
              ...
              test('single destruct with colon-eq', {code: 'for (var {a:=c} of z);', throws: true});
              test('correct dynamic property destructuring', {
                code: 'for (var {[x]: y} of obj);',
                ast: {
                  type: 'Program',
              ...
              test('dynamic property destructuring missing alias', {code: 'for (var {[x]} of obj);', throws: 'computed property name', tokens: []});
              test('dynamic property destructuring with default missing alias', {code: 'for (var {[x] = y} of obj);', throws: 'computed property name', tokens: []});
              test('correct dynamic property destructuring with default and alias', {
                code: 'for (var {[x]: y = z} of obj);',
                ast: {
                  type: 'Program',
      ...
      describe('in export decl', _ => {
        ...
        describe('regular vars', _ => {
          test('var, one var, no init, semi', {
            ...
            ast: {
              type: 'Program',
              body: [{type: 'ExportNamedDeclaration', specifiers: [], declaration: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: null}]}, source: null}],
            },
              ...
              body: [
                {
                  type: 'ExportNamedDeclaration',
                  specifiers: [],
                  declaration: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: {type: 'Identifier', name: 'bar'}}]},
                  source: null,
                },
              ],
            },
          ...
          test('var on next line does not trigger asi 1', {
            code: 'export\nvar foo',
            SCRIPT: {throws: 'module goal'},
            ast: {
              type: 'Program',
          ...
          test('var on next line does not trigger asi 2', {
            code: 'export var\nfoo',
            SCRIPT: {throws: 'module goal'},
            ast: {
              type: 'Program',
        ...
        describe('destructuring', _ => {
          describe('array', _ => {
                ...
                body: [
                  {
                    type: 'ExportNamedDeclaration',
                    specifiers: [],
                    declaration: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: []}, init: {type: 'Identifier', name: 'x'}}]},
                    source: null,
                  },
                ],
              },
                ...
                body: [
                  {
                    type: 'ExportNamedDeclaration',
                    specifiers: [],
                    declaration: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}]}, init: {type: 'Identifier', name: 'arr'}}]},
                    source: null,
                  },
                ],
              },
                ...
                body: [
                  {
                    type: 'ExportNamedDeclaration',
                    specifiers: [],
                    declaration: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'Identifier', name: 'foo'}, null]}, init: {type: 'Identifier', name: 'arr'}}]},
                    source: null,
                  },
                ],
              },
            ...
            describe('rest operator', _ => {
              ...
              test('rest followed by an ident', {code: 'export var [...foo, bar] = obj;', throws: true});
              test('rest followed by a trailing comma', {code: 'export var [...foo,] = obj;', desc: 'while feasible the syntax spec currently does not have a rule for allowing trailing commas after rest', throws: true});
              test('rest followed by two commas', {code: 'export var [...foo,,] = obj;', throws: true});
              test('rest on a nested destruct', {
                code: 'export var [...[foo, bar]] = obj;',
                ast: {
                  type: 'Program',
              ...
              test('trailing comma after rest on a nested destruct', {code: 'export var [...[foo, bar],] = obj;', throws: true});
              test('double trailing comma after rest on a nested destruct', {code: 'export var [...[foo, bar],,] = obj;', throws: true});
              test('second param rest on a nested destruct', {
              ...
              test('rest with default', {code: 'export var [...bar = foo] = obj;', desc: 'rest cannot get a default in var decls but they can as func args', throws: true});
              test('double rest / spread rest', {code: 'export var [... ...foo] = obj;', throws: 'Can not rest twice', SCRIPT: {throws: 'module goal'}});
              test('rest without value', {code: 'export var [...] = obj;', throws: true});
              test('rest with comma without value', {code: 'export var [...,] = obj;', throws: true});
              test('single dot vs rest', {code: 'export var [.x] = obj;', throws: true});
              test('double dot vs rest', {code: 'export var [..x] = obj;', throws: true});
              test('spread and rest', {
          ...
          describe('object', _ => {
                ...
                body: [
                  {
                    type: 'ExportNamedDeclaration',
                    specifiers: [],
                    declaration: {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ObjectPattern', properties: []}, init: {type: 'Identifier', name: 'obj'}}]},
                    source: null,
                  },
                ],
              },
            ...
            test('single destruct with colon-eq', {code: 'export var {a:=c} = z;', throws: true});
            test('correct dynamic property destructuring', {
              code: 'export var {[x]: y} = z;',
              ast: {
                type: 'Program',
            ...
            test('dynamic property destructuring missing alias', {code: 'export var {[x]} = z;', throws: 'computed property name', SCRIPT: {throws: 'can only be used with the module goal'}, tokens: []});
            test('dynamic property destructuring missing alias and init', {code: 'export var {[x]};', throws: 'computed property name', SCRIPT: {throws: 'can only be used with the module goal'}, tokens: []});
            test('dynamic property destructuring missing assignment', {code: 'export var {[x]: y};', throws: 'destructuring must have init', SCRIPT: {throws: 'can only be used with the module goal'}, tokens: []});
            test('dynamic property destructuring with default missing alias', {code: 'export var {[x] = y} = z;', throws: 'computed property name', SCRIPT: {throws: 'can only be used with the module goal'}, tokens: []});
            test('dynamic property destructuring with default and alias missing init', {code: 'export var {[x]: y = z};', throws: 'destructuring must have init', SCRIPT: {throws: 'can only be used with the module goal'}, tokens: []});
            test('correct dynamic property destructuring with default and alias', {
      ...
      describe('rest', _ => {
        test('rest arr', {
          ...
          ast: {
            type: 'Program',
            body: [
              {type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'ArrayPattern', elements: [{type: 'RestElement', argument: {type: 'Identifier', name: 'x'}}]}, init: {type: 'Identifier', name: 'y'}}]},
            ],
          },
        ...
        test.fail('ummmm no', {code: 'var ...x = y'});
      });
    });
    test('html comment close marks start of single line comment', {
      code: 'var foo = [23]\n-->[0];',
      MODULE: {throws: true, desc: 'because `[23]\n--` is actually `[23];--` and `>` is not a valid operand'},
      ast: {
        type: 'Program',
        body: [{type: 'VariableDeclaration', kind: 'var', declarations: [{type: 'VariableDeclarator', id: {type: 'Identifier', name: 'foo'}, init: {type: 'ArrayExpression', elements: [{type: 'Literal', value: 23, raw: '23'}]}}]}],
      },
    ...
    test.pass('destructuring edge case', {code: 'var {[2]: y} = {2:3}'});
    test.pass('destructuring case', {code: 'var {[2]: y = 1} = {2:3}'});
    describe('regressions #12', _ => {
      test.pass(' 1', {code: 'var {[a]: [b]} = c'});
      test.pass(' 2', {code: 'var {[a]: b} = c'});
      test.pass(' 3', {code: 'var {a: [b]} = c'});
      test.pass(' 4', {code: 'var {a,b=0,c:d,e:f=0,[g]:[h]}=0'});
      test.pass(' 5', {code: "var m = 'foo'; var {[m]:[z]} = {foo:[1]}"});
    });
