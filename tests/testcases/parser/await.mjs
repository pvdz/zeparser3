...
import {
  ...
  $TICK_TAIL,
  $WHITE,
} from '../../../src/zetokenizer.mjs'; // await is parsed as an AwaitExpression when the [Await] parameter is present. The [Await] parameter is present in the following contexts:
...
export default (describe, test) =>
  describe('await', _ => {
    ...
    test('await is a valid identifier in script mode 1', {
      code: 'await',
      throws: 'await',
      SLOPPY_SCRIPT: {
        ast: {
    ...
    test('await is a valid identifier in script mode 2', {
      code: 'await()',
      throws: 'await',
      SLOPPY_SCRIPT: {
        ast: {
    ...
    test('await is a valid identifier in script mode 3', {
      code: 'await[x]',
      throws: 'await',
      SLOPPY_SCRIPT: {
        ast: {
    ...
    test('await is a valid identifier in script mode 4', {
      code: 'await = 16',
    ...
    test('await is a valid identifier in script mode 5', {
      code: 'await - 25',
      tokens: [$IDENT, $PUNCTUATOR, $NUMBER_DEC, $ASI],
      ast: {
        type: 'Program',
    ...
    test('await is a valid identifier in script mode 6', {
      code: 'call(await)',
      throws: 'await',
      SLOPPY_SCRIPT: {
        ast: {
    ...
    test('await is a valid identifier in script mode 7', {
      code: 'call(await())',
      throws: 'await',
      SLOPPY_SCRIPT: {
        ast: {
    ...
    test('await is a valid identifier in script mode 8', {
      code: 'call(await[1])',
    ...
    test('await is a valid identifier in script mode 9', {
      code: 'call(await.foo)',
      throws: 'await',
      SLOPPY_SCRIPT: {
        ast: {
      ...
      describe('await with arg', _ => {
        describe('in global', _ => {
          ...
          describe('arrow, just an await', _ => {
            ...
            test.fail('await can be unary arg 1 1', {
              code: '(foo = +await bar) => {}',
            });
            test.fail('await can be unary arg 1 2', {
              code: 'async (foo = +await bar) => {}',
            });
          });
    ...
    describe('await in group in param default', _ => {
      ...
      test.pass('group await piggy test in arrow param default 1', {
        code: '(x=(await)=y)=>z',
      ...
      test.pass('group await piggy test in func param default 1', {
      ...
      test.fail('group bad await piggy test in async func param default 1', {
        code: 'async function f(x=(await)=y){}',
        desc: 'await in arrow param is always an error',
      });
      test.fail('group await piggy test in async func param default 1', {
      ...
      test.fail('group await piggy test in arrow param default 2', {
      ...
      test.fail('group await piggy test in func param default 2', {
        code: 'async function f(){    function g(x=(await z)=y){}   }',
        desc: 'the await is a var name so does not expect the `z`',
      });
      test.fail('group bad await piggy test in async func param default 2', {
        code: 'async function f(){    async function g(x=(await)=y){}   }',
      });
      test.fail('group await piggy test in async func param default 2', {
