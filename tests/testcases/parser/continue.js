...
module.exports = (describe, test) =>
  describe('continue statement', _ => {
    ...
    test('double continue', {
      ...
      ast: {
        type: 'Program',
        body: [{type: 'ContinueStatement', label: null}, {type: 'ContinueStatement', label: null}],
      },
    ...
    test('double continue with label and semi', {
      ...
      ast: {
        type: 'Program',
        body: [{type: 'ContinueStatement', label: {type: 'Identifier', name: 'foo'}}, {type: 'ContinueStatement', label: null}],
      },
