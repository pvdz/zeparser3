  ...
  describe('assigns', _ => {
    ...
    describe('assigning to keyword', _ => {
      ...
      describe('`await` is only but always an illegal var name with the _module_ goal', _ => {
        ...
        test.fail_strict('assign to paren-wrapped await var 1', {
          code: '(await) = 1',
        });
        test.fail('assign to paren-wrapped await var 2', {
      ...
      [
        ...
        let prefixed =
          ...
          keyword
            ...
            .padStart(4, '0') +
          keyword.slice(1);
        test.fail('func leading escape [' + keyword + ' => ' + prefixed + ']', {
          code: 'async function f(){   (' + prefixed + ' "sentinal 45334")   }',
        });
        test.fail_strict('arrow leading escape [' + keyword + ' => ' + prefixed + ']', {
        ...
        let middled =
          ...
          keyword
            ...
            .padStart(4, '0') +
          keyword.slice(2);
        test.fail('func second char escaped [' + keyword + ' => ' + middled + ']', {
          code: 'async function f(){   (' + middled + ' "sentinal 45334")   }',
        });
        test.fail_strict('arrow second char escaped [' + keyword + ' => ' + middled + ']', {
      ...
      [
        ...
        let prefixed =
          ...
          keyword
            ...
            .padStart(4, '0') +
          keyword.slice(1);
        test.fail('func cannot be yield expression [' + keyword + ' => ' + prefixed + ']', {
        ...
        let middled =
          ...
          keyword
            ...
            .padStart(4, '0') +
          keyword.slice(2);
        test.fail('func cannot be yield expression [' + keyword + ' => ' + middled + ']', {
