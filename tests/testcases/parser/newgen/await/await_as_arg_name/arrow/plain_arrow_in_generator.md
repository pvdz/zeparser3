...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/await/await_as_arg_name/arrow/plain_arrow_in_generator.md
...
tokens (14x):
       ...
       PUNCTUATOR IDENT PUNCTUATOR PUNCTUATOR IDENT ASI PUNCTUATOR
`````
