...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/objects/destructuring/destruct_assignment_when_value_is_property_of_number.md
          ...
          properties: [
            {
              ...
              value: {
                ...
                object: { type: 'Literal', value: 15, raw: '15.' },
