...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/objects/destructuring/identifier_properties/ax003ab_identifier_check/strict-mode_only_objlit_keywordx003dinterface.md

> :: objects : destructuring : identifier properties : a:b identifier check
>
> ::> strict-mode only, objlit, keyword=interface
