...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/objects/method_names_can_be_x0060prototypex0060/gen_async.md
  ...
  body: [
    {
      ...
      expression: {
        ...
        right: {
          ...
          loc:{start:{line:1,col:3},end:{line:1,col:27},source:''},
          properties: [
            {
              type: 'Property',
