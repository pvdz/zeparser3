...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/objects/literals/cannot_use_as_binding_destruct_x005bx0060interfacex0060x005d.md

> :: objects : literals
>
> ::> cannot use as binding destruct [`interface`]
