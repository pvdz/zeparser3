...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/new/new_operator/regex_edge_cases/regex_as_value_sans_paren.md
...
tokens (7x):
       IDENT PUNCTUATOR IDENT REGEX PUNCTUATOR ASI
`````
