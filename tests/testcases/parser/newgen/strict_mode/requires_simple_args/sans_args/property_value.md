...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/strict_mode/requires_simple_args/sans_args/property_value.md
  ...
  body: [
    {
      ...
      expression: {
        ...
        properties: [
          {
            type: 'Property',
            loc:{start:{line:1,col:2},end:{line:1,col:29},source:''},
            key: {
              type: 'Identifier',
