...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/strict_mode/header_requirements_for_directive_in_body/ident_x003d_x005binterfacex005d/function_decl/as_param_name_w_directive.md
...
`````js
function d(interface){ "use strict"; }
`````
