...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/strict_mode/header_requirements_for_directive_in_body/ident_x003d_x005bimplementsx005d/function_expr/assigned_to_in_param_default_w_directive.md
...
`````js
f = function f(x=implements=10){ "use strict"; }
`````
