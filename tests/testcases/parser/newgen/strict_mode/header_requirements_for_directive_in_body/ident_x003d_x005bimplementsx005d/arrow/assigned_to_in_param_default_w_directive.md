...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/strict_mode/header_requirements_for_directive_in_body/ident_x003d_x005bimplementsx005d/arrow/assigned_to_in_param_default_w_directive.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# PUNCTUATOR : nl=N ws=N 19:21 curc=61 `=>`#}
