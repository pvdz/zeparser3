...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/update_x0028incrementx002fdecrementx0029_ops/decremental_prefix/with_newline/func.md
        ...
        body: [
          {
            ...
            loc:{start:{line:1,col:14},end:{line:2,col:3},source:''},
            argument: {
              type: 'UpdateExpression',
              loc:{start:{line:1,col:21},end:{line:2,col:1},source:''},
              operator: '--',
              prefix: true,
              argument: {
                type: 'Identifier',
