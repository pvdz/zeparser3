...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/update_x0028incrementx002fdecrementx0029_ops/decremental_prefix/with_newline/sub-statement.md
  ...
  body: [
    {
      ...
      consequent: {
        ...
        loc:{start:{line:1,col:7},end:{line:2,col:2},source:''},
        expression: {
