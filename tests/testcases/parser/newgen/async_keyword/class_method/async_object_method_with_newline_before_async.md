...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/async_keyword/class_method/async_object_method_with_newline_before_async.md
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,col:8},end:{line:2,col:15},source:''},
        body: [
          {
