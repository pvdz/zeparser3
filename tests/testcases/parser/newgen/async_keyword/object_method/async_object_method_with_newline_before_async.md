...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/async_keyword/object_method/async_object_method_with_newline_before_async.md
...
ast: {
  type: 'Program',
  loc:{start:{line:1,col:0},end:{line:2,col:16},source:''},
  body: [
    {
      ...
      expression: {
        ...
        loc:{start:{line:1,col:1},end:{line:2,col:15},source:''},
        properties: [
          {
            type: 'Property',
