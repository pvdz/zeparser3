...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/async_keyword/object_method/async_object_method_with_newline_after_name.md
  ...
  body: [
    {
      ...
      expression: {
        ...
        properties: [
          {
            type: 'Property',
            loc:{start:{line:1,col:2},end:{line:2,col:6},source:''},
            key: {
              type: 'Identifier',
