...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/templates/and_yield/in_generator/yield_in_with_another_part.md
  ...
  body: [
    {
      ...
      body: {
        type: 'BlockStatement',
        loc:{start:{line:1,col:13},end:{line:1,col:50},source:''},
        body: [
          {
            type: 'ExpressionStatement',
            loc:{start:{line:1,col:17},end:{line:1,col:49},source:''},
            expression: {
