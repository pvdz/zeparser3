...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/for_statement/for-loop/double_proto/double_proto_of_lhs_arr_in_web_compat.md
  ...
  body: [
    {
      ...
      init: {
        ...
        loc:{start:{line:1,col:5},end:{line:1,col:35},source:''},
        elements: [
          {
