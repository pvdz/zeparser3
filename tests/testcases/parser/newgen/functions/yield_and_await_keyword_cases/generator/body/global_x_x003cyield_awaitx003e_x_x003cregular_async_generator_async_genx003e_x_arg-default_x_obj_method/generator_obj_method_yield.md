...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/functions/yield_and_await_keyword_cases/generator/body/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_arg-default_x_obj_method/generator_obj_method_yield.md
                ...
                properties: [
                  {
                    ...
                    value: {
                      ...
                      body: {
                        type: 'BlockStatement',
                        loc:{start:{line:1,col:26},end:{line:1,col:47},source:''},
                        body: [
                          {
                            type: 'ReturnStatement',
                            loc:{start:{line:1,col:28},end:{line:1,col:46},source:''},
                            argument: {
