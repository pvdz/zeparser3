...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/functions/yield_and_await_keyword_cases/generator/body/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_arg-default_x_expr/async_func_expr_await.md
  ...
  body: [
    {
      ...
      body: {
        type: 'BlockStatement',
        loc:{start:{line:1,col:14},end:{line:1,col:66},source:''},
        body: [
          {
            ...
            declarations: [
              {
                ...
                init: {
                  ...
                  loc:{start:{line:1,col:30},end:{line:1,col:65},source:''},
                  generator: false,
                  async: true,
                  id: {
                    type: 'Identifier',
                  ...
                  body: {
                    type: 'BlockStatement',
                    loc:{start:{line:1,col:43},end:{line:1,col:65},source:''},
                    body: [
                      {
