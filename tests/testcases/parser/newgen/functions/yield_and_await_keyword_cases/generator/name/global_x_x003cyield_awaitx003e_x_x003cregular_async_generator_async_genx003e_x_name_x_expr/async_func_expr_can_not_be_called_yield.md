...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/functions/yield_and_await_keyword_cases/generator/name/global_x_x003cyield_awaitx003e_x_x003cregular_async_generator_async_genx003e_x_name_x_expr/async_func_expr_can_not_be_called_yield.md
        ...
        body: [
          {
            ...
            loc:{start:{line:1,col:20},end:{line:1,col:50},source:''},
            kind: 'let',
            declarations: [
              {
                ...
                init: {
                  ...
                  loc:{start:{line:1,col:30},end:{line:1,col:50},source:''},
                  generator: false,
                  async: true,
                  id: {
                    type: 'Identifier',
