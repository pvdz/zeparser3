  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,col:8},end:{line:1,col:56},source:''},
        body: [
          {
            type: 'MethodDefinition',
            loc:{start:{line:1,col:10},end:{line:1,col:55},source:''},
            key: {
              type: 'Identifier',
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:15},end:{line:1,col:55},source:''},
                body: [
                  {
                    type: 'ClassDeclaration',
                    ...
                    superClass: {
                      ...
                      loc:{start:{line:1,col:38},end:{line:1,col:48},source:''},
                      object: {
                        type: 'Super',
                    ...
                    body: {
                      type: 'ClassBody',
                      loc:{start:{line:1,col:48},end:{line:1,col:54},source:''},
                      body: []
                    }
                  }
                ]
