...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/classes/piggies_in_classes/super_prop/wrapped_in_plain_class_in_method/computed_no_arg.md
            ...
            value: {
              ...
              body: {
                ...
                body: [
                  {
                    type: 'ClassDeclaration',
                    loc:{start:{line:1,col:22},end:{line:1,col:51},source:''},
                    id: {
                      type: 'Identifier',
