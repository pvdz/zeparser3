...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/classes/constructor_name_checks/escapes_should_be_canonical/unicode_in_idents/constructor_ident_can_have_unicode_escape.md

> :: classes : constructor name checks : escapes should be canonical : unicode in idents
>
> ::> constructor ident can have unicode escape
  ...
  body: [
    {
      ...
      body: {
        type: 'ClassBody',
        loc:{start:{line:1,col:8},end:{line:1,col:32},source:''},
        body: [
          {
