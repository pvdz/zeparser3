...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/super_keyword/superx0028x0029/class_constructors/ok_to_omit_from_constructor_of_class_that_extends_another_class.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:34},end:{line:1,col:38},source:''},
                body: []
              }
            }
          }
