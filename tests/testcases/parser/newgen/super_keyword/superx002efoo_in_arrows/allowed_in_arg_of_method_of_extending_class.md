...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/super_keyword/superx002efoo_in_arrows/allowed_in_arg_of_method_of_extending_class.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:26},end:{line:1,col:56},source:''},
                body: [
                  {
                    type: 'ReturnStatement',
                    loc:{start:{line:1,col:28},end:{line:1,col:55},source:''},
                    argument: {
                      type: 'ArrowFunctionExpression',
                      loc:{start:{line:1,col:35},end:{line:1,col:53},source:''},
                      params: [
                        {
                      ...
                      body: {
                        type: 'Identifier',
                        loc:{start:{line:1,col:52},end:{line:1,col:53},source:''},
                        name: 'a'
                      }
                    }
                  }
