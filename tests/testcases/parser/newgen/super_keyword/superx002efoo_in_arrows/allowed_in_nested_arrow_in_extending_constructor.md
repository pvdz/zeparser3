...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/super_keyword/superx002efoo_in_arrows/allowed_in_nested_arrow_in_extending_constructor.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:33},end:{line:1,col:66},source:''},
                body: [
                  {
                    type: 'ReturnStatement',
                    loc:{start:{line:1,col:35},end:{line:1,col:65},source:''},
                    argument: {
                      type: 'ArrowFunctionExpression',
                      loc:{start:{line:1,col:42},end:{line:1,col:63},source:''},
                      params: [],
                      id: null,
                      generator: false,
                      async: false,
                      ...
                      body: {
                        ...
                        body: {
                          ...
                          loc:{start:{line:1,col:54},end:{line:1,col:63},source:''},
                          object: {
                            type: 'Super',
