...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/super_keyword/superx002efoo_in_arrows/allowed_in_extending_constructor.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:33},end:{line:1,col:60},source:''},
                body: [
                  {
                    type: 'ReturnStatement',
                    loc:{start:{line:1,col:35},end:{line:1,col:59},source:''},
                    argument: {
                      type: 'ArrowFunctionExpression',
                      loc:{start:{line:1,col:42},end:{line:1,col:57},source:''},
                      params: [],
                      id: null,
                      generator: false,
                      async: false,
