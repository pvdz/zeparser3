...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/super_keyword/superx0028x0029_in_arrows/allowed_in_nested_arrow_in_valid_constructor.md
        ...
        body: [
          {
            ...
            loc:{start:{line:1,col:20},end:{line:1,col:64},source:''},
            key: {
              type: 'Identifier',
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:33},end:{line:1,col:64},source:''},
                body: [
                  {
                    ...
                    argument: {
                      ...
                      body: {
                        type: 'ArrowFunctionExpression',
                        loc:{start:{line:1,col:48},end:{line:1,col:61},source:''},
                        params: [],
                        id: null,
                        generator: false,
                        async: false,
