...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/super_keyword/superx0028x0029_in_arrows/allowed_in_extending_constructor.md
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:1,col:33},end:{line:1,col:58},source:''},
                body: [
                  {
