...
- Path: tests/testcases/parser/regexes/some_annexb_stuff/invalid_escape_char/gen/Character_class_range_left_without_uflag

> :: test: Character class range left without uflag
>
> :: case: B
