...
throws: Tokenizer error!
    The escaped property value `` is not valid (does not appear in "table 56" nor "table 57") with u-flag, and `\p` is not valid without u-flag and without webcompat
...
`````
throws: Tokenizer error!
    The escaped property value `` is not valid (does not appear in "table 56" nor "table 57")
