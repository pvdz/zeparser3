...
throws: Tokenizer error!
    The escaped binary property name `` is not valid (does not appear in "table 54") with u-flag, and `\p` is not valid without u-flag and without webcompat
...
`````
throws: Tokenizer error!
    The escaped binary property name `` is not valid (does not appear in "table 54")
