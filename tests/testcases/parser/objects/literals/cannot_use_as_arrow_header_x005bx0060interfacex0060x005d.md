...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/objects/literals/cannot_use_as_arrow_header_x005bx0060interfacex0060x005d.md

> :: objects : literals
>
> ::> cannot use as arrow header [`interface`]
