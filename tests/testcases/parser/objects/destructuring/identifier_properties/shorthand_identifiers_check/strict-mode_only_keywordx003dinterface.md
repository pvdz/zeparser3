...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/objects/destructuring/identifier_properties/shorthand_identifiers_check/strict-mode_only_keywordx003dinterface.md

> :: objects : destructuring : identifier properties : shorthand identifiers check
>
> ::> strict-mode only keyword=interface
