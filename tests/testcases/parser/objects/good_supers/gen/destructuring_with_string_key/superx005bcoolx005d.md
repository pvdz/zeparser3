...
- Path: tests/testcases/parser/objects/good_supers/gen/destructuring_with_string_key
                ...
                body: [
                  {
                    ...
                    expression: {
                      ...
                      loc:{start:{line:3,col:5},end:{line:3,col:29},source:''},
                      left: {
                        type: 'ObjectPattern',
                        loc:{start:{line:3,col:5},end:{line:3,col:26},source:''},
                        properties: [
                          {
                            type: 'Property',
                            loc:{start:{line:3,col:6},end:{line:3,col:24},source:''},
                            key: {
                              type: 'Literal',
                            ...
                            value: {
                              ...
                              loc:{start:{line:3,col:13},end:{line:3,col:24},source:''},
                              object: {
                                type: 'Super',
                              ...
                              property: {
                                type: 'Identifier',
                                loc:{start:{line:3,col:19},end:{line:3,col:23},source:''},
                                name: 'cool'
                              },
                              computed: true
                            },
                      ...
                      right: {
                        type: 'Identifier',
                        loc:{start:{line:3,col:28},end:{line:3,col:29},source:''},
                        name: 'x'
                      }
                    }
                  }
