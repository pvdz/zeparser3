...
- Path: tests/testcases/parser/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/class_method_as_param_name_w_directive

> :: test: class method; as param name w directive
>
> :: case: ok
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:2,column:7},end:{line:5,column:0},source:''},
                body: [
                  {
