...
- Path: tests/testcases/parser/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/class_constructor_as_param_name_w_directive
        ...
        body: [
          {
            ...
            value: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:2,column:17},end:{line:5,column:0},source:''},
                body: [
                  {
