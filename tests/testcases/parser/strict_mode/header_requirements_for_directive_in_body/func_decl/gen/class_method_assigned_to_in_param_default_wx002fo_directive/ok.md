...
- Path: zeparser3/tests/testcases/parser/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/class_method_assigned_to_in_param_default_wx002fo_directive

> :: test: class method; assigned to in param default w/o directive
>
> :: case: ok
        ...
        body: [
          {
            ...
            value: {
              ...
              params: [
                {
                  ...
                  loc:{start:{line:2,col:4},end:{line:2,col:11},source:''},
                  left: {
                    type: 'Identifier',
                  ...
                  right: {
                    ...
                    loc:{start:{line:2,col:6},end:{line:2,col:11},source:''},
                    left: {
                      type: 'Identifier',
                      loc:{start:{line:2,col:6},end:{line:2,col:8},source:''},
                      name: 'ok'
                    },
                    operator: '=',
                    right: {
              ...
              body: {
                type: 'BlockStatement',
                loc:{start:{line:2,col:12},end:{line:3,col:0},source:''},
                body: []
              }
            }
          }
