...
- Modified: -
- Path: zeparser3/tests/testcases/parser/newgen/strict_mode/header_requirements_for_directive_in_body/ident_x003d_x005bargumentsx005d/class_method/as_method_name_w_directive.md

> :: strict mode : header requirements for directive in body : ident = [arguments] : class method
>
        ...
        body: [
          {
            ...
            loc:{start:{line:1,col:9},end:{line:1,col:37},source:''},
            key: {
              type: 'Identifier',
