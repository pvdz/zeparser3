...
- Modified: -
- Path: zeparser3/tests/testcases/parser/const_statement/binding_generic/yield/yield_in_sloppy_mode_should_still_throw_without_generator.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# IDENT : nl=N ws=N 26:27 curc=97 `a`#}
