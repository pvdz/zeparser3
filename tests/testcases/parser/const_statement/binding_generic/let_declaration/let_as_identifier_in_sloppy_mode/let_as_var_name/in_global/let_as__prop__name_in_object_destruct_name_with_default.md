...
- Modified: -
- Path: zeparser3/tests/testcases/parser/const_statement/binding_generic/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_global/let_as__prop__name_in_object_destruct_name_with_default.md

> :: const statement : binding generic : let declaration : let as identifier in sloppy mode : let as var name : in global
>
> ::> let as _prop_ name in object destruct name with default
