...
- Modified: -
- Path: zeparser3/tests/testcases/parser/const_statement/binding_generic/let_declaration/binding_generic/arguments_check.md

> :: const statement : binding generic : let declaration : binding generic
>
> ::> arguments check
