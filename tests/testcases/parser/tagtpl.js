...
module.exports = (describe, test) => describe('tagged templates', _ => {
    ...
    ast: {type: 'Program', body: [
      {type: 'ExpressionStatement', expression: {
        ...
        quasi: {
          ...
          expressions: [],
          quasis: [
            {type: 'TemplateElement', value: {raw: 'bar', cooked: '<TODO>'}, tail: true},
          ],
        }
      }},
    ]},
    ...
    ast: {type: 'Program', body: [
      {type: 'ExpressionStatement', expression: {
        ...
        quasi: {
          ...
          expressions: [],
          quasis: [
            {type: 'TemplateElement', value: {raw: 'H\\x45Y', cooked: '<TODO>'}, tail: true},
          ],
        }
      }},
    ]},
