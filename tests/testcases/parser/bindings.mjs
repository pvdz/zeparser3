    ...
    describe('catch', _ => {
      ...
      describe('for-in edge case', _ => {
        ...
        describe('without webcompat', _ => {
          ...
          test.fail('catch var as for-in binding 1', {
            code: 'try {} catch (e) { for (var e;;) {} }',
          });
          test.fail('catch var as for-in binding 2', {
        ...
        describe('with webcompat', _ => {
          ...
          test.pass('catch var as for-in binding 1', {
            code: 'try {} catch (e) { for (var e;;) {} }',
            WEB: true,
          });
          test.pass('catch var as for-in binding 2', {
            code: 'try {} catch (e) { for (var e in y) {} }',
            WEB: true,
          });
          test.fail('catch var as for-of binding', {
