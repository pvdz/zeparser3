...
- Path: tests/testcases/let_declaration/binding_generic/in_a_for-header/destructuring/regular_for-loop/object/double_destruct_both_with_init.md
...
tokens (19x):
       ...
       IDENT PUNC_COMMA IDENT PUNC_EQ IDENT PUNC_CURLY_CLOSE PUNC_EQ
