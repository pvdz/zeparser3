...
- Path: tests/testcases/let_declaration/binding_generic/in_a_for-header/destructuring/regular_for-loop/array/double_trailing_comma_is_significant.md
...
tokens (15x):
       ...
       PUNC_COMMA PUNC_COMMA PUNC_BRACKET_CLOSE PUNC_EQ IDENT
