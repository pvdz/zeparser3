...
- Path: tests/testcases/let_declaration/binding_generic/in_a_for-header/destructuring/for-in/object/double_destruct_both_with_rename.md
...
tokens (17x):
       ...
       IDENT PUNC_COMMA IDENT PUNC_COLON IDENT PUNC_CURLY_CLOSE ID_in
