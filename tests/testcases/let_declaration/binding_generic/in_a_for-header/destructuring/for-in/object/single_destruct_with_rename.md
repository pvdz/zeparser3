...
- Path: tests/testcases/let_declaration/binding_generic/in_a_for-header/destructuring/for-in/object/single_destruct_with_rename.md
...
tokens (13x):
       ...
       IDENT PUNC_CURLY_CLOSE IDENT IDENT PUNC_PAREN_CLOSE PUNC_SEMI
`````
