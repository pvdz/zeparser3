...
- Path: tests/testcases/let_declaration/binding_generic/in_a_for-header/destructuring/for-in/array/two_vars_without_and_with_initializer.md
...
tokens (15x):
       ...
       IDENT PUNC_EQ IDENT PUNC_BRACKET_CLOSE IDENT IDENT
