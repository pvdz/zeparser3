...
- Path: tests/testcases/let_declaration/binding_generic/in_a_for-header/regular_vars/regular_for-loop/let_two_vars_no_init_semi.md
...
tokens (11x):
       ID_for PUNC_PAREN_OPEN ID_let IDENT PUNC_COMMA IDENT PUNC_SEMI
