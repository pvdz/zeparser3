...
- Path: tests/testcases/let_declaration/binding_generic/in_export_decl/destructuring/object/double_destruct_without_and_with_init.md
...
tokens (13x):
       ID_export ID_let PUNC_CURLY_OPEN IDENT PUNC_COMMA IDENT PUNC_EQ
