...
- Path: tests/testcases/let_declaration/binding_generic/in_export_decl/destructuring/object/destruct_and_non-destruct_without_init.md
...
tokens (11x):
       ...
       IDENT PUNC_COMMA IDENT PUNC_SEMI
`````
