...
- Path: tests/testcases/let_declaration/binding_generic/in_export_decl/destructuring/array/with_one_var_no_init_semi.md
...
tokens (9x):
       IDENT IDENT PUNC_BRACKET_OPEN IDENT PUNC_BRACKET_CLOSE PUNC_EQ
       IDENT PUNC_SEMI
`````
