...
- Path: tests/testcases/let_declaration/binding_generic/in_export_decl/destructuring/array/double_trailing_comma_is_significant.md
...
tokens (11x):
       ID_export ID_let PUNC_BRACKET_OPEN IDENT PUNC_COMMA PUNC_COMMA
