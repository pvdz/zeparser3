...
- Path: tests/testcases/let_declaration/binding_generic/as_a_statement/regular_vars/let_two_vars_with_both_init_semi.md
...
tokens (10x):
       ID_let IDENT PUNC_EQ IDENT PUNC_COMMA IDENT PUNC_EQ IDENT
       PUNC_SEMI
`````
