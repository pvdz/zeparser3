...
- Path: tests/testcases/let_declaration/binding_generic/as_a_statement/destructuring/array/empty_array_with_double_comma.md
...
tokens (9x):
       IDENT PUNC_BRACKET_OPEN PUNC_COMMA PUNC_COMMA
