...
- Path: tests/testcases/let_declaration/binding_generic/as_a_statement/destructuring/array/non-destruct_without_init_and_destruct.md
...
tokens (10x):
       IDENT IDENT PUNC_COMMA PUNC_BRACKET_OPEN IDENT
