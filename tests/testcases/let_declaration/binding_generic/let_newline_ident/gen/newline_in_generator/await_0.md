...
- Path: tests/testcases/let_declaration/binding_generic/let_newline_ident/gen/newline_in_generator/await_0.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# NUMBER_DEC : nl=N ws=N pos=30:31 loc=8:3 curc=48 `0`#}
