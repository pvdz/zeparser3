...
- Path: tests/testcases/let_declaration/binding_generic/let_newline_ident/gen/newline_in_async/evalx0028foox0029.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# PUNC_PAREN_OPEN : nl=N ws=N pos=33:34 loc=6:3 curc=40 `(`#}
