...
- Path: tests/testcases/let_declaration/binding_generic/let_newline_ident/gen/newline_in_async/argumentsx002elength.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# PUNCTUATOR : nl=N ws=N pos=38:39 loc=11:3 curc=46 `.`#}
