...
- Path: tests/testcases/let_declaration/binding_generic/let_newline_ident/gen/newline_in_async/public.md
...
tokens (11x):
       ...
       PUNC_CURLY_OPEN ID_let ID_public ASI PUNC_CURLY_CLOSE
`````
