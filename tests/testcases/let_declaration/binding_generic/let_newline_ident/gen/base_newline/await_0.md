...
- Path: tests/testcases/let_declaration/binding_generic/let_newline_ident/gen/base_newline/await_0.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# NUMBER_DEC : nl=N ws=N pos=10:11 loc=6:2 curc=48 `0`#}
