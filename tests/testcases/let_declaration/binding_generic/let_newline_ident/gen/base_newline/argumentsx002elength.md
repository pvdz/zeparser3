...
- Path: tests/testcases/let_declaration/binding_generic/let_newline_ident/gen/base_newline/argumentsx002elength.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# PUNCTUATOR : nl=N ws=N pos=13:14 loc=9:2 curc=46 `.`#}
