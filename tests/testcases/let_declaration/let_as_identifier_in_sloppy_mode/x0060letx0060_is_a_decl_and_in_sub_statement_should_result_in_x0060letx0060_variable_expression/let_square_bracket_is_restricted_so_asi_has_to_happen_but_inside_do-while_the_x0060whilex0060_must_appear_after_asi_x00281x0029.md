...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/x0060letx0060_is_a_decl_and_in_sub_statement_should_result_in_x0060letx0060_variable_expression/let_square_bracket_is_restricted_so_asi_has_to_happen_but_inside_do-while_the_x0060whilex0060_must_appear_after_asi_x00281x0029.md
...
>
> ::> let square bracket is restricted so asi has to happen but inside do-while the x0060whilex0060 must appear after asi x00281x0029
>
