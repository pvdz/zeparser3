...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/dynamic_prop_on_let_var/illegal_ambiguous_cases/proper_case_with_less_confusing_newline.md
