...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_asi_block/illegal_ambiguous_cases/in_arrow_expr_body_2.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# PUNC_CURLY_OPEN : nl=N ws=N pos=9:10 loc=9:1 curc=123 `{`#}
