...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_for-loop-header/var_decl.md
...
tokens (9x):
       ID_for PUNC_PAREN_OPEN ID_var ID_let PUNC_SEMI PUNC_SEMI
