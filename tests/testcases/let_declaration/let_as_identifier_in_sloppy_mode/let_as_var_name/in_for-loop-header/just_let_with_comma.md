...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_for-loop-header/just_let_with_comma.md
...
tokens (10x):
       ID_for PUNC_PAREN_OPEN ID_let PUNC_COMMA IDENT PUNC_SEMI
