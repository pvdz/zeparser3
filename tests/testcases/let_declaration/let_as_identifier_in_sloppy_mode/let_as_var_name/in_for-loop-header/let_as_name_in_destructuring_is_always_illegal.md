...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_for-loop-header/let_as_name_in_destructuring_is_always_illegal.md
