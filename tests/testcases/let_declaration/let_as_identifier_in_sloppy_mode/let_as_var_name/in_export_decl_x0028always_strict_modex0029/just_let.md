...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_export_decl_x0028always_strict_modex0029/just_let.md
...
`````
throws: Parser error!
  Expected identifier, or array/object destructuring, next token is: {# PUNCTUATOR : nl=N ws=N pos=10:11 loc=10:1 curc=59 `;`#}
