...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_global/let_as__prop__name_in_object_destructuring_is_okay.md

> :: let declaration : let as identifier in sloppy mode : let as var name : in global
>
> ::> let as prop name in object destructuring is okay
>
...
tokens (10x):
       ID_let PUNC_CURLY_OPEN ID_let PUNC_COLON IDENT PUNC_CURLY_CLOSE
