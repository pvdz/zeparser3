...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_global/let_as__alias__in_object_destruct_name_as_second_name_is_bad.md

> :: let declaration : let as identifier in sloppy mode : let as var name : in global
>
> ::> let as alias in object destruct name as second name is bad
>
