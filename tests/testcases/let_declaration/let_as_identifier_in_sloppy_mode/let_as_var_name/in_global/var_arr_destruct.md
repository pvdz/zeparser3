...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_global/var_arr_destruct.md
...
tokens (8x):
       ID_var PUNC_BRACKET_OPEN ID_let PUNC_BRACKET_CLOSE PUNC_EQ
       IDENT PUNC_SEMI
`````
