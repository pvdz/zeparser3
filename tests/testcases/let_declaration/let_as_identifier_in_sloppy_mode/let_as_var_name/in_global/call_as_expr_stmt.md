...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_global/call_as_expr_stmt.md
...
tokens (5x):
       ID_let PUNC_PAREN_OPEN PUNC_PAREN_CLOSE PUNC_SEMI
`````
