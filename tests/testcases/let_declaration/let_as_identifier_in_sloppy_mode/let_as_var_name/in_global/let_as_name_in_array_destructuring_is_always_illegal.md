...
- Path: tests/testcases/let_declaration/let_as_identifier_in_sloppy_mode/let_as_var_name/in_global/let_as_name_in_array_destructuring_is_always_illegal.md
