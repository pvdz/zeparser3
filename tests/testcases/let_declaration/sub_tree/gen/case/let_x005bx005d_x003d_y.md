...
- Path: tests/testcases/let_declaration/sub_tree/gen/case/let_x005bx005d_x003d_y.md
...
tokens (16x):
       ...
       PUNC_CURLY_OPEN ID_case IDENT PUNC_COLON ID_let
       PUNC_BRACKET_OPEN PUNC_BRACKET_CLOSE PUNC_EQ IDENT ASI
       PUNC_CURLY_CLOSE
`````
