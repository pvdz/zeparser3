...
- Path: tests/testcases/var_statement/binding_generic/in_export_decl/regular_vars/var_two_vars_with_both_init_semi.md
...
tokens (11x):
       IDENT IDENT IDENT PUNC_EQ IDENT PUNC_COMMA IDENT PUNC_EQ IDENT
       PUNC_SEMI
`````
