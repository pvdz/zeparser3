...
- Path: tests/testcases/var_statement/binding_generic/as_a_statement/regular_vars/var_var_with_init_asi.md
...
tokens (9x):
       IDENT IDENT PUNC_EQ IDENT ASI IDENT IDENT PUNC_SEMI
`````
