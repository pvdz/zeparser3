...
- Path: tests/testcases/var_statement/binding_generic/in_a_for-header/destructuring/regular_for-loop/array/non-destruct_without_init_and_destruct.md
...
tokens (15x):
       IDENT PUNC_PAREN_OPEN IDENT IDENT PUNC_COMMA PUNC_BRACKET_OPEN
