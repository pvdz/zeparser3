...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/function_array_destructured_arg/await.md
...
tokens (10x):
       ID_function IDENT PUNC_PAREN_OPEN PUNC_BRACKET_OPEN ID_await
