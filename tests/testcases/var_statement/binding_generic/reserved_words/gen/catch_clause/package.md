...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/catch_clause/package.md
...
tokens (10x):
       ...
       PUNC_PAREN_OPEN ID_package PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
       PUNC_CURLY_CLOSE
`````
