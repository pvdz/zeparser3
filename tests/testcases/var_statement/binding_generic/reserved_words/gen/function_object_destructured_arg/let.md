...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/function_object_destructured_arg/let.md
...
tokens (10x):
       ID_function IDENT PUNC_PAREN_OPEN PUNC_CURLY_OPEN ID_let
