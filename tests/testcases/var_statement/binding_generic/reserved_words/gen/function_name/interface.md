...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/function_name/interface.md
...
tokens (7x):
       ID_function ID_interface PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
