...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/function_name/implements.md
...
tokens (7x):
       ID_function ID_implements PUNC_PAREN_OPEN PUNC_PAREN_CLOSE
