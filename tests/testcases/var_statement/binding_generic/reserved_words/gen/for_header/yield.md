...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/for_header/yield.md
...
tokens (11x):
       ID_for PUNC_PAREN_OPEN ID_var ID_yield PUNC_EQ IDENT PUNC_SEMI
