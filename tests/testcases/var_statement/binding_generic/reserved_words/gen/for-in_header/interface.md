...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/gen/for-in_header/interface.md
...
tokens (9x):
       ID_for PUNC_PAREN_OPEN ID_var ID_interface ID_in IDENT
