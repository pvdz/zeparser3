...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dinterface/for_header.md
...
tokens (11x):
       ID_for PUNC_PAREN_OPEN ID_var ID_interface PUNC_EQ IDENT
