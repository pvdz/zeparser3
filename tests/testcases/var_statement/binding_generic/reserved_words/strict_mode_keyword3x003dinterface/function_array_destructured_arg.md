...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dinterface/function_array_destructured_arg.md
...
tokens (10x):
       ...
       ID_interface PUNC_BRACKET_CLOSE PUNC_PAREN_CLOSE
