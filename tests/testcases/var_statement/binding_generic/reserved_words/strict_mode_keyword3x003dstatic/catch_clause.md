...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dstatic/catch_clause.md
...
tokens (10x):
       ...
       PUNC_PAREN_OPEN ID_static PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
       PUNC_CURLY_CLOSE
`````
