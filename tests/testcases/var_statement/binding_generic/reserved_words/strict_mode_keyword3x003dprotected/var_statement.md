...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dprotected/var_statement.md
...
tokens (6x):
       ID_var ID_protected PUNC_EQ IDENT PUNC_SEMI
`````
