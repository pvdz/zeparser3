...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dimplements/var_statement.md
...
tokens (6x):
       IDENT IDENT PUNC_EQ IDENT PUNC_SEMI
`````
