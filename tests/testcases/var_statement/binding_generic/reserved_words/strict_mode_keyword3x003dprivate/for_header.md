...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dprivate/for_header.md
...
tokens (11x):
       ID_for PUNC_PAREN_OPEN ID_var ID_private PUNC_EQ IDENT
