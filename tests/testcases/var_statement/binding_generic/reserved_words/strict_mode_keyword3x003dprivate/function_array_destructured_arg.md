...
- Path: tests/testcases/var_statement/binding_generic/reserved_words/strict_mode_keyword3x003dprivate/function_array_destructured_arg.md
...
tokens (10x):
       ID_function IDENT PUNC_PAREN_OPEN PUNC_BRACKET_OPEN ID_private
