...
- Path: tests/testcases/yield/arguments_checks/more_arg_checks/yield_var_legal_in_async_arrow_arg_default.md
...
tokens (11x):
       IDENT PUNC_PAREN_OPEN IDENT PUNC_EQ IDENT PUNC_PAREN_CLOSE
