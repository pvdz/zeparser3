...
- Path: tests/testcases/yield/yield_in_group_in_param_default/group_yieldx002barg_piggy_test_in_arrow_param_default.md

> :: yield : yield in group in param default
>
> ::> group yieldx002barg piggy test in arrow param default
>
