...
tokens (52x):
       IDENT IDENT PUNC_EQ IDENT IDENT PUNC_STAR IDENT PUNC_PAREN_OPEN
       PUNC_PAREN_CLOSE PUNC_CURLY_OPEN IDENT PUNC_PLUS_EQ NUMBER_DEC
       PUNC_SEMI IDENT PUNC_CURLY_OPEN PUNC_DOT_DOT_DOT IDENT IDENT
       PUNC_COMMA PUNC_DOT_DOT_DOT PUNC_PAREN_OPEN IDENT
       PUNC_PAREN_OPEN IDENT PUNC_PAREN_CLOSE PUNC_CURLY_OPEN IDENT
       IDENT PUNC_EQ IDENT PUNC_SEMI IDENT PUNC_CURLY_OPEN
       PUNC_DOT_DOT_DOT IDENT PUNC_CURLY_CLOSE PUNC_SEMI
       PUNC_CURLY_CLOSE PUNC_PAREN_OPEN IDENT PUNC_PAREN_CLOSE
       PUNC_PAREN_CLOSE PUNC_COMMA PUNC_DOT_DOT_DOT IDENT PUNC_COMMA
       PUNC_CURLY_CLOSE ASI PUNC_CURLY_CLOSE PUNC_SEMI
`````
