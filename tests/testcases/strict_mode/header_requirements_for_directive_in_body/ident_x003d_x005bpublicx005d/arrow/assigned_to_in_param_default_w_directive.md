...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/ident_x003d_x005bpublicx005d/arrow/assigned_to_in_param_default_w_directive.md
...
`````
throws: Parser error!
  Unable to ASI, token: {# PUNC_EQ_GT : nl=N pos=15:17 loc=15:1 `=>`#}
