...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/obj_method_assigned_to_in_param_default_wx002fo_directive/implements.md
          ...
          properties: [
            {
              ...
              value: {
                ...
                body: {
                  type: 'BlockStatement',
                  loc:{start:{line:2,column:20},end:{line:2,column:23},source:''},
                  body: []
                }
              },
              shorthand: false
...
tokens (16x):
       ...
       PUNC_EQ ID_implements PUNC_EQ NUMBER_DEC PUNC_PAREN_CLOSE
