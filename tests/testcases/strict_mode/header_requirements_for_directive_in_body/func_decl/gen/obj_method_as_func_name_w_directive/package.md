...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/obj_method_as_func_name_w_directive/package.md
...
tokens (14x):
       IDENT PUNC_EQ PUNC_CURLY_OPEN ID_package PUNC_PAREN_OPEN IDENT
