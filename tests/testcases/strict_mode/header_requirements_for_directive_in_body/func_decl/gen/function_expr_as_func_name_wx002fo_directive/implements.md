...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/function_expr_as_func_name_wx002fo_directive/implements.md
...
tokens (11x):
       IDENT PUNC_EQ ID_function ID_implements PUNC_PAREN_OPEN IDENT
