...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/arrow_as_param_name_w_directive/ok.md

> :: strict mode : header requirements for directive in body : func decl : gen : arrow as param name w directive
>
> ::> ok
...
tokens (10x):
       PUNCTUATOR IDENT PUNCTUATOR PUNCTUATOR PUNCTUATOR STRING_DOUBLE
