...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/obj_method_as_param_name_wx002fo_directive/implements.md
          ...
          properties: [
            {
              ...
              value: {
                ...
                params: [
                  {
                    type: 'Identifier',
                    loc:{start:{line:2,column:4},end:{line:2,column:14},source:''},
                    name: 'implements'
                  }
                ],
                body: {
...
tokens (12x):
       ...
       ID_implements PUNC_PAREN_CLOSE PUNC_CURLY_OPEN PUNC_CURLY_CLOSE
