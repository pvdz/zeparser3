...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/function_expr_as_param_name_w_directive/ok.md

> :: strict mode : header requirements for directive in body : func decl : gen : function expr as param name w directive
>
> ::> ok
...
tokens (13x):
       IDENT PUNC_EQ IDENT IDENT PUNC_PAREN_OPEN IDENT
