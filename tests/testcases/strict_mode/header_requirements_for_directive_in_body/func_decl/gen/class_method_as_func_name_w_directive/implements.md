...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/class_method_as_func_name_w_directive/implements.md
...
tokens (13x):
       ID_class IDENT PUNC_CURLY_OPEN ID_implements PUNC_PAREN_OPEN
...
````js
class A{implements(b){"use strict";};}
````
