...
- Path: tests/testcases/strict_mode/header_requirements_for_directive_in_body/func_decl/gen/class_method_as_func_name_w_directive/interface.md
...
````js
class A{interface(b){"use strict";};}
````
