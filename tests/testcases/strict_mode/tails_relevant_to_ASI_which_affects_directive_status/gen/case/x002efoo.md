...
- Path: tests/testcases/strict_mode/tails_relevant_to_ASI_which_affects_directive_status/gen/case/x002efoo.md
...
tokens (11x):
       ...
       STRING_DOUBLE PUNC_DOT IDENT ASI PUNC_CURLY_CLOSE
`````
