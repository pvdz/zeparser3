...
- Path: tests/testcases/strict_mode/tails_relevant_to_ASI_which_affects_directive_status/gen/case/--x.md
...
tokens (12x):
       ...
       STRING_DOUBLE ASI PUNC_MIN_MIN IDENT ASI PUNC_CURLY_CLOSE
`````
