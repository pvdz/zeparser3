...
- Path: tests/testcases/group_or_arrow/group/invalid_arrow_header_things_that_are_valid_in_a_group/gen/assignment/let.md
...
tokens (7x):
       PUNC_PAREN_OPEN ID_let PUNC_PAREN_CLOSE PUNC_EQ IDENT ASI
`````
