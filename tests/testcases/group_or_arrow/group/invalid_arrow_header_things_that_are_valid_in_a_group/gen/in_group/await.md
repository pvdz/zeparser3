...
- Path: tests/testcases/group_or_arrow/group/invalid_arrow_header_things_that_are_valid_in_a_group/gen/in_group/await.md
...
tokens (5x):
       PUNC_PAREN_OPEN ID_await PUNC_PAREN_CLOSE ASI
`````
