...
- Path: tests/testcases/group_or_arrow/group/invalid_arrow_header_things_that_are_valid_in_a_group/gen/in_group/eval.md
...
tokens (5x):
       PUNC_PAREN_OPEN ID_eval PUNC_PAREN_CLOSE ASI
`````
