...
- Path: tests/testcases/group_or_arrow/group/invalid_arrow_header_things_that_are_valid_in_a_group/gen/in_group/typeof_x.md
...
tokens (6x):
       PUNC_PAREN_OPEN ID_typeof IDENT PUNC_PAREN_CLOSE ASI
`````
