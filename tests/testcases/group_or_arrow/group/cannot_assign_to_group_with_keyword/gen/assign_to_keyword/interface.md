...
- Path: tests/testcases/group_or_arrow/group/cannot_assign_to_group_with_keyword/gen/assign_to_keyword/interface.md
...
tokens (7x):
       PUNC_PAREN_OPEN ID_interface PUNC_PAREN_CLOSE PUNC_EQ IDENT ASI
`````
