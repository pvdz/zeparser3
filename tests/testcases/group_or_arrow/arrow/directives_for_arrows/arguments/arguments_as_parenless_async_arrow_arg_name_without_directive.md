...
- Path: tests/testcases/group_or_arrow/arrow/directives_for_arrows/arguments/arguments_as_parenless_async_arrow_arg_name_without_directive.md
...
tokens (7x):
       IDENT IDENT PUNC_EQ_GT PUNC_CURLY_OPEN PUNC_CURLY_CLOSE ASI
`````
