...
- Path: tests/testcases/group_or_arrow/arrow/MUST_DESTRUCT_cases/array_without_nesting/in_a_for-in.md
...
tokens (14x):
       ...
       PUNC_EQ IDENT PUNC_CURLY_CLOSE PUNC_BRACKET_CLOSE ID_in IDENT
