...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/delete_paren_arg/x_x003dx003e_ok.md
...
tokens (8x):
       IDENT PUNC_PAREN_OPEN IDENT PUNC_EQ_GT IDENT PUNC_PAREN_CLOSE
       ASI
`````
