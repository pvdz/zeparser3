...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/dynamic_property/async_async_x003dx003e_ok.md
...
tokens (9x):
       ID_async ID_async PUNC_EQ_GT IDENT PUNC_BRACKET_OPEN IDENT
