...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/arg_default/async_async_x003dx003e_ok.md
...
tokens (13x):
       ...
       ID_async PUNC_EQ_GT IDENT PUNC_PAREN_CLOSE PUNC_CURLY_OPEN
       PUNC_CURLY_CLOSE
`````
