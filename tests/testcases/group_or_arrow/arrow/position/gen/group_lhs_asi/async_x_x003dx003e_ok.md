...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/group_lhs_asi/async_x_x003dx003e_ok.md
...
tokens (10x):
       PUNC_PAREN_OPEN IDENT IDENT PUNC_EQ_GT IDENT PUNC_PAREN_CLOSE
       PUNC_STAR IDENT ASI
`````
