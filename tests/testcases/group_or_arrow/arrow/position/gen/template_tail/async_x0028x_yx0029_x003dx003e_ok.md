...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/template_tail/async_x0028x_yx0029_x003dx003e_ok.md
...
tokens (14x):
       TICK_HEAD IDENT PUNCTUATOR IDENT PUNCTUATOR IDENT PUNCTUATOR
       PUNCTUATOR IDENT TICK_TAIL PUNCTUATOR IDENT ASI
`````
