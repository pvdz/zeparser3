...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/template_tail/async_x_x003dx003e_ok.md
...
tokens (10x):
       TICK_HEAD IDENT IDENT PUNC_EQ_GT IDENT TICK_TAIL PUNC_DOT IDENT
       ASI
`````
