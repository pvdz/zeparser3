...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/template_tail/async_x003dx003e_ok.md
...
tokens (9x):
       TICK_HEAD IDENT PUNCTUATOR IDENT TICK_TAIL PUNCTUATOR IDENT ASI
`````
