...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/arr/async_x0028x_yx0029_x003dx003e_ok.md
...
tokens (12x):
       ...
       IDENT PUNC_PAREN_CLOSE PUNC_EQ_GT IDENT PUNC_BRACKET_CLOSE ASI
`````
