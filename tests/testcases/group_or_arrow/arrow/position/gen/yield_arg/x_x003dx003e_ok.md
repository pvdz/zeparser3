...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/yield_arg/x_x003dx003e_ok.md
...
tokens (13x):
       ...
       PUNC_CURLY_OPEN ID_yield IDENT PUNC_EQ_GT IDENT ASI
       PUNC_CURLY_CLOSE
`````
