...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/yield_arg/async_x_x003dx003e_ok.md
        ...
        body: [
          {
            ...
            expression: {
              ...
              argument: {
                ...
                loc:{start:{line:2,column:8},end:{line:2,column:21},source:''},
                params: [
                  {
                    type: 'Identifier',
...
tokens (14x):
       ...
       PUNC_CURLY_OPEN ID_yield ID_async IDENT PUNC_EQ_GT IDENT ASI
       PUNC_CURLY_CLOSE
`````
