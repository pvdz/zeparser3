...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/postfix_update/async_x0028x_yx0029_x003dx003e_ok.md
...
tokens (11x):
       ...
       PUNC_PAREN_CLOSE PUNC_EQ_GT IDENT PUNC_PLUS_PLUS ASI
`````
