...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/lhs_div_div/async_async_x003dx003e_ok.md
  ...
  body: [
    {
      ...
      expression: {
        ...
        body: {
          ...
          loc:{start:{line:1,column:15},end:{line:2,column:7},source:''},
          left: {
            type: 'BinaryExpression',
...
tokens (10x):
       IDENT IDENT PUNC_EQ_GT IDENT PUNC_DIV IDENT PUNC_DIV IDENT ASI
`````
