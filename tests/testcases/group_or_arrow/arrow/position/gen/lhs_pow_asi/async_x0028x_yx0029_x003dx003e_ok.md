...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/lhs_pow_asi/async_x0028x_yx0029_x003dx003e_ok.md
  ...
  body: [
    {
      ...
      expression: {
        ...
        body: {
          ...
          loc:{start:{line:1,column:16},end:{line:2,column:4},source:''},
          left: {
            type: 'Identifier',
...
tokens (12x):
       ...
       PUNC_PAREN_CLOSE PUNC_EQ_GT IDENT PUNC_STAR_STAR IDENT ASI
`````
