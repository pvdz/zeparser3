...
- Path: tests/testcases/group_or_arrow/arrow/position/gen/lhs_pow_asi/async_async_x003dx003e_ok.md
...
tokens (8x):
       ID_async ID_async PUNC_EQ_GT IDENT PUNC_STAR_STAR IDENT ASI
`````
