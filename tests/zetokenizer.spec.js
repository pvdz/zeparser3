...
//import whitespaces from './testcases/whitespaces';
let whitespaces = require('./testcases/whitespaces');
//import comments from './testcases/comments';
let comments = require('./testcases/comments');
//import punctuators from './testcases/punctuators';
let punctuators = require('./testcases/punctuators');
//import numbers from './testcases/numbers';
let numbers = require('./testcases/numbers');
//import identifiers from './testcases/identifiers';
let identifiers = require('./testcases/identifiers');
//import strings_single from './testcases/strings_single';
let strings_single = require('./testcases/strings_single');
//import strings_double from './testcases/strings_double';
let strings_double = require('./testcases/strings_double');
//import regexesn from './testcases/regexesn';
let regexesn = require('./testcases/regexesn');
//import regexesu from './testcases/regexesu';
let regexesu = require('./testcases/regexesu');
//import strings_template_static from './testcases/strings_template_static';
let strings_template_static = require('./testcases/strings_template_static');
//import strings_template_head from './testcases/strings_template_head';
let strings_template_head = require('./testcases/strings_template_head');
//import strings_template_body from './testcases/strings_template_body';
let strings_template_body = require('./testcases/strings_template_body');
//import strings_template_tail from './testcases/strings_template_tail';
let strings_template_tail = require('./testcases/strings_template_tail');
